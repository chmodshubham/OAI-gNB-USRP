...
asn_TYPE_member_t asn_MBR_X2AP_E_RABs_ToBeSetupRetrieve_Item_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct X2AP_E_RABs_ToBeSetupRetrieve_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_X2AP_ProtocolExtensionContainer_8421P43,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_X2AP_E_RABs_ToBeSetupRetrieve_Item_specs_1 = {
