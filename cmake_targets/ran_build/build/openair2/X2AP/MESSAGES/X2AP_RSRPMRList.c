...
asn_per_constraints_t asn_PER_type_X2AP_RSRPMRList_constr_1 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_X2AP_Member_2[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct X2AP_RSRPMRList__Member, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_X2AP_ProtocolExtensionContainer_8421P190,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_TYPE_member_t asn_MBR_X2AP_RSRPMRList_1[] = {
	{ ATF_POINTER, 0, 0,
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
...
asn_SET_OF_specifics_t asn_SPC_X2AP_RSRPMRList_specs_1 = {
