...
static asn_TYPE_member_t asn_MBR_X2AP_value_4[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_UnsuccessfulOutcome__value, choice.SgNBAdditionRequestReject),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_X2AP_SgNBAdditionRequestReject,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"SgNBAdditionRequestReject"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_UnsuccessfulOutcome__value, choice.SgNBModificationRequestReject),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_X2AP_SgNBModificationRequestReject,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"SgNBModificationRequestReject"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_UnsuccessfulOutcome__value, choice.SgNBModificationRefuse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_X2AP_SgNBModificationRefuse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"SgNBModificationRefuse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_UnsuccessfulOutcome__value, choice.SgNBReleaseRequestReject),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_X2AP_SgNBReleaseRequestReject,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"SgNBReleaseRequestReject"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_UnsuccessfulOutcome__value, choice.SgNBChangeRefuse),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_X2AP_SgNBChangeRefuse,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"SgNBChangeRefuse"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_UnsuccessfulOutcome__value, choice.ENDCX2SetupFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_X2AP_ENDCX2SetupFailure,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ENDCX2SetupFailure"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_UnsuccessfulOutcome__value, choice.ENDCConfigurationUpdateFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_X2AP_ENDCConfigurationUpdateFailure,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ENDCConfigurationUpdateFailure"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_UnsuccessfulOutcome__value, choice.ENDCCellActivationFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_X2AP_ENDCCellActivationFailure,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ENDCCellActivationFailure"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct X2AP_UnsuccessfulOutcome__value, choice.ENDCX2RemovalFailure),
		(ASN_TAG_CLASS_UNIVERSAL | (16 << 2)),
		0,
		&asn_DEF_X2AP_ENDCX2RemovalFailure,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
