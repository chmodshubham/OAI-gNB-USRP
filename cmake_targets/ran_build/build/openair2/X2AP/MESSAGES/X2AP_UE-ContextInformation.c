...
asn_TYPE_member_t asn_MBR_X2AP_UE_ContextInformation_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct X2AP_UE_ContextInformation, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_X2AP_ProtocolExtensionContainer_8421P0,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_X2AP_UE_ContextInformation_specs_1 = {
