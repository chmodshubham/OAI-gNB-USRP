 ...
 */
static int
memb_LTE_harq_ProcID_Offset_r15_constraint_61(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_type_LTE_cyclicShiftSPS_r15_constr_62 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_LTE_rv_SPS_UL_Repetitions_r15_constr_72 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_constr_77 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  3 }	/* (0..3) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_LTE_harq_ProcID_Offset_r15_constr_71 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 3,  3,  0,  7 }	/* (0..7) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
...
static const asn_INTEGER_enum_map_t asn_MAP_LTE_cyclicShiftSPS_r15_value2enum_62[] = {
	{ 0,	3,	"cs0" },
	{ 1,	3,	"cs1" },
	{ 2,	3,	"cs2" },
	{ 3,	3,	"cs3" },
...
static const unsigned int asn_MAP_LTE_cyclicShiftSPS_r15_enum2value_62[] = {
	0,	/* cs0(0) */
	1,	/* cs1(1) */
	2,	/* cs2(2) */
	3,	/* cs3(3) */
...
static const asn_INTEGER_specifics_t asn_SPC_LTE_cyclicShiftSPS_r15_specs_62 = {
	asn_MAP_LTE_cyclicShiftSPS_r15_value2enum_62,	/* "tag" => N; sorted by tag */
	asn_MAP_LTE_cyclicShiftSPS_r15_enum2value_62,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_LTE_cyclicShiftSPS_r15_tags_62[] = {
	(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LTE_cyclicShiftSPS_r15_62 = {
	"cyclicShiftSPS-r15",
	"cyclicShiftSPS-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_LTE_cyclicShiftSPS_r15_tags_62,
	sizeof(asn_DEF_LTE_cyclicShiftSPS_r15_tags_62)
		/sizeof(asn_DEF_LTE_cyclicShiftSPS_r15_tags_62[0]) - 1, /* 1 */
	asn_DEF_LTE_cyclicShiftSPS_r15_tags_62,	/* Same as above */
	sizeof(asn_DEF_LTE_cyclicShiftSPS_r15_tags_62)
		/sizeof(asn_DEF_LTE_cyclicShiftSPS_r15_tags_62[0]), /* 2 */
	{ 0, &asn_PER_type_LTE_cyclicShiftSPS_r15_constr_62, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_LTE_cyclicShiftSPS_r15_specs_62	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_LTE_rv_SPS_UL_Repetitions_r15_value2enum_72[] = {
	{ 0,	8,	"ulrvseq1" },
	{ 1,	8,	"ulrvseq2" },
	{ 2,	8,	"ulrvseq3" }
};
static const unsigned int asn_MAP_LTE_rv_SPS_UL_Repetitions_r15_enum2value_72[] = {
	0,	/* ulrvseq1(0) */
	1,	/* ulrvseq2(1) */
	2	/* ulrvseq3(2) */
};
static const asn_INTEGER_specifics_t asn_SPC_LTE_rv_SPS_UL_Repetitions_r15_specs_72 = {
	asn_MAP_LTE_rv_SPS_UL_Repetitions_r15_value2enum_72,	/* "tag" => N; sorted by tag */
	asn_MAP_LTE_rv_SPS_UL_Repetitions_r15_enum2value_72,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_LTE_rv_SPS_UL_Repetitions_r15_tags_72[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LTE_rv_SPS_UL_Repetitions_r15_72 = {
	"rv-SPS-UL-Repetitions-r15",
	"rv-SPS-UL-Repetitions-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_LTE_rv_SPS_UL_Repetitions_r15_tags_72,
	sizeof(asn_DEF_LTE_rv_SPS_UL_Repetitions_r15_tags_72)
		/sizeof(asn_DEF_LTE_rv_SPS_UL_Repetitions_r15_tags_72[0]) - 1, /* 1 */
	asn_DEF_LTE_rv_SPS_UL_Repetitions_r15_tags_72,	/* Same as above */
	sizeof(asn_DEF_LTE_rv_SPS_UL_Repetitions_r15_tags_72)
		/sizeof(asn_DEF_LTE_rv_SPS_UL_Repetitions_r15_tags_72[0]), /* 2 */
	{ 0, &asn_PER_type_LTE_rv_SPS_UL_Repetitions_r15_constr_72, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_LTE_rv_SPS_UL_Repetitions_r15_specs_72	/* Additional specs */
};

static const asn_INTEGER_enum_map_t asn_MAP_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_value2enum_77[] = {
	{ 0,	2,	"n2" },
	{ 1,	2,	"n3" },
	{ 2,	2,	"n4" },
	{ 3,	2,	"n6" }
};
static const unsigned int asn_MAP_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_enum2value_77[] = {
	0,	/* n2(0) */
	1,	/* n3(1) */
	2,	/* n4(2) */
	3	/* n6(3) */
};
static const asn_INTEGER_specifics_t asn_SPC_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_specs_77 = {
	asn_MAP_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_value2enum_77,	/* "tag" => N; sorted by tag */
	asn_MAP_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_enum2value_77,	/* N => "tag"; sorted by N */
	4,	/* Number of elements in the maps */
	0,	/* Enumeration is not extensible */
	1,	/* Strict enumeration */
	0,	/* Native long size */
...
static const ber_tlv_tag_t asn_DEF_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_tags_77[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_77 = {
	"totalNumberPUSCH-SPS-UL-Repetitions-r15",
	"totalNumberPUSCH-SPS-UL-Repetitions-r15",
	&asn_OP_NativeEnumerated,
	asn_DEF_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_tags_77,
	sizeof(asn_DEF_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_tags_77)
		/sizeof(asn_DEF_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_tags_77[0]) - 1, /* 1 */
	asn_DEF_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_tags_77,	/* Same as above */
	sizeof(asn_DEF_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_tags_77)
		/sizeof(asn_DEF_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_tags_77[0]), /* 2 */
	{ 0, &asn_PER_type_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_constr_77, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_specs_77	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_LTE_ext4_61[] = {
	{ ATF_POINTER, 6, offsetof(struct LTE_SPS_ConfigUL__setup__ext4, cyclicShiftSPS_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_cyclicShiftSPS_r15_62,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"cyclicShiftSPS-r15"
		},
	{ ATF_POINTER, 5, offsetof(struct LTE_SPS_ConfigUL__setup__ext4, harq_ProcID_Offset_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LTE_harq_ProcID_Offset_r15_constr_71,  memb_LTE_harq_ProcID_Offset_r15_constraint_61 },
		0, 0, /* No default value */
		"harq-ProcID-Offset-r15"
		},
	{ ATF_POINTER, 4, offsetof(struct LTE_SPS_ConfigUL__setup__ext4, rv_SPS_UL_Repetitions_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_rv_SPS_UL_Repetitions_r15_72,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"rv-SPS-UL-Repetitions-r15"
		},
	{ ATF_POINTER, 3, offsetof(struct LTE_SPS_ConfigUL__setup__ext4, tpc_PDCCH_ConfigPUSCH_SPS_r15),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_SPS_ConfigUL__setup__ext4, totalNumberPUSCH_SPS_UL_Repetitions_r15),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_totalNumberPUSCH_SPS_UL_Repetitions_r15_77,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"totalNumberPUSCH-SPS-UL-Repetitions-r15"
		},
	{ ATF_POINTER, 1, offsetof(struct LTE_SPS_ConfigUL__setup__ext4, sps_ConfigIndex_r15),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_LTE_ext4_oms_61[] = { 0, 1, 2, 3, 4, 5 };
...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_ext4_specs_61 = {
	sizeof(struct LTE_SPS_ConfigUL__setup__ext4),
	offsetof(struct LTE_SPS_ConfigUL__setup__ext4, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_LTE_setup_3[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct LTE_SPS_ConfigUL__setup, p0_Persistent),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct LTE_SPS_ConfigUL__setup, twoIntervalsConfig),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct LTE_SPS_ConfigUL__setup, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_LTE_ext1_32,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct LTE_SPS_ConfigUL__setup, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_LTE_ext2_38,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_SPS_ConfigUL__setup, ext3),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_LTE_ext3_40,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_SPS_ConfigUL__setup, ext4),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_LTE_ext4_61,
		0,
...
static const int asn_MAP_LTE_setup_oms_3[] = { 2, 3, 4, 5, 6, 7 };
