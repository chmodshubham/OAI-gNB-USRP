...
typedef enum LTE_ReportConfigEUTRA__triggerType__event__eventId_PR {
	...
	LTE_ReportConfigEUTRA__triggerType__event__eventId_PR_eventH1_r15,
	LTE_ReportConfigEUTRA__triggerType__event__eventId_PR_eventH2_r15
...
typedef enum LTE_ReportConfigEUTRA__ext8__purpose_r15 {
	LTE_ReportConfigEUTRA__ext8__purpose_r15_sensing	= 0
} e_LTE_ReportConfigEUTRA__ext8__purpose_r15;

/* Forward declarations */
struct LTE_RSRQ_RangeConfig_r12;
struct LTE_MeasRSSI_ReportConfig_r13;
struct LTE_UL_DelayConfig_r13;
struct LTE_BT_NameListConfig_r15;
struct LTE_WLAN_NameListConfig_r15;
...
typedef struct LTE_ReportConfigEUTRA {
			...
			struct LTE_ReportConfigEUTRA__triggerType__event {
				struct LTE_ReportConfigEUTRA__triggerType__event__eventId {
					...
					union LTE_ReportConfigEUTRA__LTE_triggerType__LTE_event__LTE_eventId_u {
						...
						struct LTE_ReportConfigEUTRA__triggerType__event__eventId__eventH1_r15 {
						...
						struct LTE_ReportConfigEUTRA__triggerType__event__eventId__eventH2_r15 {
	...
	struct LTE_ReportConfigEUTRA__ext7 {
		long	*maxReportRS_Index_r15;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext7;
	struct LTE_ReportConfigEUTRA__ext8 {
		struct LTE_BT_NameListConfig_r15	*includeBT_Meas_r15;	/* OPTIONAL */
		struct LTE_WLAN_NameListConfig_r15	*includeWLAN_Meas_r15;	/* OPTIONAL */
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_purpose_41;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_triggerQuantity_44;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_reportQuantity_47;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_reportAmount_52;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_si_RequestForHO_r9_63;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_ue_RxTxTimeDiffPeriodical_r9_65;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_includeLocationInfo_r10_68;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_reportAddNeighMeas_r10_70;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_triggerQuantity_v1310_88;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_reportQuantity_v1310_92;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_includeMultiBandInfo_r13_98;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_purpose_v1430_104;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_purpose_r15_114;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_LTE_ReportConfigEUTRA_1[14];
...
#include "LTE_BT-NameListConfig-r15.h"
#include "LTE_WLAN-NameListConfig-r15.h"
