...
static asn_TYPE_member_t asn_MBR_LTE_ext3_24[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_ConnEstFailReport_r11__ext3, logMeasResultListBT_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_ConnEstFailReport_r11__ext3, logMeasResultListWLAN_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_LTE_ext3_oms_24[] = { 0, 1 };
...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_ext3_specs_24 = {
	sizeof(struct LTE_ConnEstFailReport_r11__ext3),
	offsetof(struct LTE_ConnEstFailReport_r11__ext3, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LTE_ConnEstFailReport_r11_1[] = {
	...
	{ ATF_POINTER, 4, offsetof(struct LTE_ConnEstFailReport_r11, measResultListEUTRA_v1130),
	...
	{ ATF_POINTER, 3, offsetof(struct LTE_ConnEstFailReport_r11, ext1),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_LTE_ext1_18,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_ConnEstFailReport_r11, ext2),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_LTE_ext2_22,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_ConnEstFailReport_r11, ext3),
		(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
		0,
		&asn_DEF_LTE_ext3_24,
		0,
...
static const int asn_MAP_LTE_ConnEstFailReport_r11_oms_1[] = { 1, 3, 8, 9, 10, 11 };
