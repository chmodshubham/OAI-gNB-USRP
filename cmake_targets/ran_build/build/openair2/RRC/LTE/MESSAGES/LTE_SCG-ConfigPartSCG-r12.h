...
typedef struct LTE_SCG_ConfigPartSCG_r12 {
	...
	struct LTE_SCG_ConfigPartSCG_r12__ext4 {
		struct LTE_SCellGroupToReleaseList_r15	*sCellGroupToReleaseListSCG_r15;	/* OPTIONAL */
		struct LTE_SCellGroupToAddModList_r15	*sCellGroupToAddModListSCG_r15;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext4;
	struct LTE_SCG_ConfigPartSCG_r12__ext5 {
		struct LTE_MeasConfig	*measConfigSN_r15;	/* OPTIONAL */
		struct LTE_TDM_PatternConfig_r15	*tdm_PatternConfigNE_DC_r15;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_LTE_SCG_ConfigPartSCG_r12_1[10];
