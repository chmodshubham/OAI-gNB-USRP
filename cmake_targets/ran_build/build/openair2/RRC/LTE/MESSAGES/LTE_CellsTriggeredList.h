...
typedef enum LTE_CellsTriggeredList__Member_PR {
	...
	LTE_CellsTriggeredList__Member_PR_physCellIdNR_r15
...
typedef struct LTE_CellsTriggeredList__Member {
	...
	union LTE_CellsTriggeredList__LTE_Member_u {
		...
		struct LTE_CellsTriggeredList__Member__physCellIdNR_r15 {
			LTE_ARFCN_ValueNR_r15_t	 carrierFreq;
			LTE_PhysCellIdNR_r15_t	 physCellId;
			struct LTE_SSB_IndexList_r15	*rs_IndexList_r15;	/* OPTIONAL */
