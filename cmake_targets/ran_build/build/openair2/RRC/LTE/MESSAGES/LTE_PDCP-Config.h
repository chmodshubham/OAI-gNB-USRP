...
typedef enum LTE_PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15 {
	LTE_PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15_kbyte2	= 0,
	LTE_PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15_kbyte4	= 1,
	LTE_PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15_kbyte8	= 2,
	LTE_PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15_spare1	= 3
} e_LTE_PDCP_Config__ext6__uplinkDataCompression_r15__bufferSize_r15;
typedef enum LTE_PDCP_Config__ext6__uplinkDataCompression_r15__dictionary_r15 {
	LTE_PDCP_Config__ext6__uplinkDataCompression_r15__dictionary_r15_sip_SDP	= 0,
	LTE_PDCP_Config__ext6__uplinkDataCompression_r15__dictionary_r15_operator	= 1
} e_LTE_PDCP_Config__ext6__uplinkDataCompression_r15__dictionary_r15;
typedef enum LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR {
	LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR_NOTHING,	/* No components present */
	LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR_release,
	LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR_setup
} LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR;
typedef enum LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15__setup__pdcp_Duplication_r15 {
	LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15__setup__pdcp_Duplication_r15_configured	= 0,
	LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15__setup__pdcp_Duplication_r15_activated	= 1
} e_LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15__setup__pdcp_Duplication_r15;
...
typedef struct LTE_PDCP_Config {
	...
	struct LTE_PDCP_Config__ext6 {
		struct LTE_PDCP_Config__ext6__uplinkDataCompression_r15 {
			long	 bufferSize_r15;
		...
		struct LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15 {
			LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15_PR present;
			union LTE_PDCP_Config__LTE_ext6__LTE_pdcp_DuplicationConfig_r15_u {
				NULL_t	 release;
				struct LTE_PDCP_Config__ext6__pdcp_DuplicationConfig_r15__setup {
...
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_bufferSize_r15_189;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_dictionary_r15_194;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_pdcp_Duplication_r15_201;	// (Use -fall-defs-global to expose) */
extern asn_TYPE_descriptor_t asn_DEF_LTE_PDCP_Config;
extern asn_SEQUENCE_specifics_t asn_SPC_LTE_PDCP_Config_specs_1;
extern asn_TYPE_member_t asn_MBR_LTE_PDCP_Config_1[10];
