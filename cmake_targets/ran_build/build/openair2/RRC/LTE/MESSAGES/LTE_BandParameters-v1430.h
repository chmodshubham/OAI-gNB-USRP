...
struct LTE_SRS_CapabilityPerBandPair_r14;
...
typedef struct LTE_BandParameters_v1430 {
	...
	struct LTE_BandParameters_v1430__srs_CapabilityPerBandPairList_r14 {
		A_SEQUENCE_OF(struct LTE_SRS_CapabilityPerBandPair_r14) list;
