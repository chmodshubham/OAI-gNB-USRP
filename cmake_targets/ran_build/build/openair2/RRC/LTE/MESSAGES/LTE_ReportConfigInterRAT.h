...
typedef enum LTE_ReportConfigInterRAT__triggerType__event__eventId_PR {
	...
	LTE_ReportConfigInterRAT__triggerType__event__eventId_PR_eventB2_NR_r15
...
typedef enum LTE_ReportConfigInterRAT__ext7__reportSFTD_Meas_r15 {
	LTE_ReportConfigInterRAT__ext7__reportSFTD_Meas_r15_pSCell	= 0,
	LTE_ReportConfigInterRAT__ext7__reportSFTD_Meas_r15_neighborCells	= 1
} e_LTE_ReportConfigInterRAT__ext7__reportSFTD_Meas_r15;

/* Forward declarations */
struct LTE_ReportQuantityWLAN_r13;
struct LTE_ReportQuantityNR_r15;
...
typedef struct LTE_ReportConfigInterRAT {
			...
			struct LTE_ReportConfigInterRAT__triggerType__event {
				struct LTE_ReportConfigInterRAT__triggerType__event__eventId {
					...
					union LTE_ReportConfigInterRAT__LTE_triggerType__LTE_event__LTE_eventId_u {
						...
						struct LTE_ReportConfigInterRAT__triggerType__event__eventId__eventB1_NR_r15 {
							LTE_ThresholdNR_r15_t	 b1_ThresholdNR_r15;
							BOOLEAN_t	 reportOnLeave_r15;
							
							/* Context for parsing across buffer boundaries */
							asn_struct_ctx_t _asn_ctx;
						} eventB1_NR_r15;
						struct LTE_ReportConfigInterRAT__triggerType__event__eventId__eventB2_NR_r15 {
							LTE_ThresholdEUTRA_t	 b2_Threshold1_r15;
							LTE_ThresholdNR_r15_t	 b2_Threshold2NR_r15;
							BOOLEAN_t	 reportOnLeave_r15;
	...
	struct LTE_ReportConfigInterRAT__ext7 {
		struct LTE_ReportQuantityNR_r15	*reportQuantityCellNR_r15;	/* OPTIONAL */
		long	*maxReportRS_Index_r15;	/* OPTIONAL */
		struct LTE_ReportQuantityNR_r15	*reportQuantityRS_IndexNR_r15;	/* OPTIONAL */
...
/* Implementation */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_purpose_34;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_reportAmount_40;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_si_RequestForHO_r9_51;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_reportQuantityUTRA_FDD_r10_54;	// (Use -fall-defs-global to expose) */
/* extern asn_TYPE_descriptor_t asn_DEF_LTE_reportSFTD_Meas_r15_71;	// (Use -fall-defs-global to expose) */
...
extern asn_TYPE_member_t asn_MBR_LTE_ReportConfigInterRAT_1[11];
