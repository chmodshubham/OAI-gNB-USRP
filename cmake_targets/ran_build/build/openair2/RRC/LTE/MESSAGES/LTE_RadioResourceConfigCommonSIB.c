...
static asn_TYPE_member_t asn_MBR_LTE_ext6_31[] = {
	{ ATF_POINTER, 4, offsetof(struct LTE_RadioResourceConfigCommonSIB__ext6, prach_Config_v1530),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_PRACH_ConfigSIB_v1530,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"prach-Config-v1530"
		},
	{ ATF_POINTER, 3, offsetof(struct LTE_RadioResourceConfigCommonSIB__ext6, ce_RSS_Config_r15),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_RSS_Config_r15,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"ce-RSS-Config-r15"
		},
	{ ATF_POINTER, 2, offsetof(struct LTE_RadioResourceConfigCommonSIB__ext6, wus_Config_r15),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_WUS_Config_r15,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"wus-Config-r15"
		},
	{ ATF_POINTER, 1, offsetof(struct LTE_RadioResourceConfigCommonSIB__ext6, highSpeedConfig_v1530),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_LTE_ext6_oms_31[] = { 0, 1, 2, 3 };
static const ber_tlv_tag_t asn_DEF_LTE_ext6_tags_31[] = {
	(ASN_TAG_CLASS_CONTEXT | (15 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_LTE_ext6_tag2el_31[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_ext6_specs_31 = {
	sizeof(struct LTE_RadioResourceConfigCommonSIB__ext6),
	offsetof(struct LTE_RadioResourceConfigCommonSIB__ext6, _asn_ctx),
	asn_MAP_LTE_ext6_tag2el_31,
	4,	/* Count of tags in the map */
	asn_MAP_LTE_ext6_oms_31,	/* Optional members */
	4, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LTE_ext6_31 = {
	"ext6",
	"ext6",
	&asn_OP_SEQUENCE,
	asn_DEF_LTE_ext6_tags_31,
	sizeof(asn_DEF_LTE_ext6_tags_31)
		/sizeof(asn_DEF_LTE_ext6_tags_31[0]) - 1, /* 1 */
	asn_DEF_LTE_ext6_tags_31,	/* Same as above */
	sizeof(asn_DEF_LTE_ext6_tags_31)
		/sizeof(asn_DEF_LTE_ext6_tags_31[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_LTE_ext6_31,
	4,	/* Elements count */
	&asn_SPC_LTE_ext6_specs_31	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_LTE_ext7_36[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_RadioResourceConfigCommonSIB__ext7, uplinkPowerControlCommon_v1540),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_LTE_ext7_oms_36[] = { 0 };
...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_ext7_specs_36 = {
	sizeof(struct LTE_RadioResourceConfigCommonSIB__ext7),
	offsetof(struct LTE_RadioResourceConfigCommonSIB__ext7, _asn_ctx),
...
static asn_TYPE_member_t asn_MBR_LTE_ext8_38[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_RadioResourceConfigCommonSIB__ext8, wus_Config_v1560),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_WUS_Config_v1560,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"wus-Config-v1560"
...
static const int asn_MAP_LTE_ext8_oms_38[] = { 0 };
static const ber_tlv_tag_t asn_DEF_LTE_ext8_tags_38[] = {
	(ASN_TAG_CLASS_CONTEXT | (17 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_LTE_ext8_tag2el_38[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* wus-Config-v1560 */
};
static asn_SEQUENCE_specifics_t asn_SPC_LTE_ext8_specs_38 = {
	sizeof(struct LTE_RadioResourceConfigCommonSIB__ext8),
	offsetof(struct LTE_RadioResourceConfigCommonSIB__ext8, _asn_ctx),
	asn_MAP_LTE_ext8_tag2el_38,
	1,	/* Count of tags in the map */
	asn_MAP_LTE_ext8_oms_38,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LTE_ext8_38 = {
	"ext8",
	"ext8",
	&asn_OP_SEQUENCE,
	asn_DEF_LTE_ext8_tags_38,
	sizeof(asn_DEF_LTE_ext8_tags_38)
		/sizeof(asn_DEF_LTE_ext8_tags_38[0]) - 1, /* 1 */
	asn_DEF_LTE_ext8_tags_38,	/* Same as above */
	sizeof(asn_DEF_LTE_ext8_tags_38)
		/sizeof(asn_DEF_LTE_ext8_tags_38[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_LTE_ext8_38,
	1,	/* Elements count */
	&asn_SPC_LTE_ext8_specs_38	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_LTE_RadioResourceConfigCommonSIB_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct LTE_RadioResourceConfigCommonSIB, ext1),
		(ASN_TAG_CLASS_CONTEXT | (10 << 2)),
		0,
		&asn_DEF_LTE_ext1_13,
		0,
	...
	{ ATF_POINTER, 7, offsetof(struct LTE_RadioResourceConfigCommonSIB, ext2),
		(ASN_TAG_CLASS_CONTEXT | (11 << 2)),
		0,
		&asn_DEF_LTE_ext2_15,
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct LTE_RadioResourceConfigCommonSIB, ext3),
		(ASN_TAG_CLASS_CONTEXT | (12 << 2)),
		0,
		&asn_DEF_LTE_ext3_17,
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct LTE_RadioResourceConfigCommonSIB, ext4),
		(ASN_TAG_CLASS_CONTEXT | (13 << 2)),
		0,
		&asn_DEF_LTE_ext4_19,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct LTE_RadioResourceConfigCommonSIB, ext5),
		(ASN_TAG_CLASS_CONTEXT | (14 << 2)),
		0,
		&asn_DEF_LTE_ext5_27,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct LTE_RadioResourceConfigCommonSIB, ext6),
		(ASN_TAG_CLASS_CONTEXT | (15 << 2)),
		0,
		&asn_DEF_LTE_ext6_31,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_RadioResourceConfigCommonSIB, ext7),
		(ASN_TAG_CLASS_CONTEXT | (16 << 2)),
		0,
		&asn_DEF_LTE_ext7_36,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_RadioResourceConfigCommonSIB, ext8),
		(ASN_TAG_CLASS_CONTEXT | (17 << 2)),
		0,
		&asn_DEF_LTE_ext8_38,
		0,
...
static const int asn_MAP_LTE_RadioResourceConfigCommonSIB_oms_1[] = { 10, 11, 12, 13, 14, 15, 16, 17 };
