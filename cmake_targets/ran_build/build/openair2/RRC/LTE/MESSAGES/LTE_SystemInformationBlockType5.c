...
asn_TYPE_member_t asn_MBR_LTE_SystemInformationBlockType5_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct LTE_SystemInformationBlockType5, lateNonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct LTE_SystemInformationBlockType5, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_LTE_ext1_5,
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct LTE_SystemInformationBlockType5, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_LTE_ext2_8,
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct LTE_SystemInformationBlockType5, ext3),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_LTE_ext3_10,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct LTE_SystemInformationBlockType5, ext4),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_LTE_ext4_13,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct LTE_SystemInformationBlockType5, ext5),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_LTE_ext5_16,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_SystemInformationBlockType5, ext6),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_LTE_ext6_18,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_SystemInformationBlockType5, ext7),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_LTE_ext7_20,
		0,
...
static const int asn_MAP_LTE_SystemInformationBlockType5_oms_1[] = { 1, 2, 3, 4, 5, 6, 7, 8 };
