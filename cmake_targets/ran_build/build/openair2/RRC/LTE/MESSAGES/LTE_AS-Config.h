...
struct LTE_AS_ConfigNR_r15;
struct LTE_AS_Config_v1550;
...
typedef struct LTE_AS_Config {
	...
	struct LTE_AS_Config__ext4 {
		struct LTE_AS_ConfigNR_r15	*as_ConfigNR_r15;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext4;
	struct LTE_AS_Config__ext5 {
		struct LTE_AS_Config_v1550	*as_Config_v1550;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_LTE_AS_Config_1[14];
