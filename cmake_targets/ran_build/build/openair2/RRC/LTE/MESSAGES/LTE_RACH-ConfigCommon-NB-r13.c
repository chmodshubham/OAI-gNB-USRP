...
static asn_TYPE_member_t asn_MBR_LTE_ext2_9[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_RACH_ConfigCommon_NB_r13__ext2, rach_InfoList_v1530),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_RACH_InfoList_NB_v1530,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"rach-InfoList-v1530"
...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_ext2_specs_9 = {
	sizeof(struct LTE_RACH_ConfigCommon_NB_r13__ext2),
	offsetof(struct LTE_RACH_ConfigCommon_NB_r13__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LTE_RACH_ConfigCommon_NB_r13_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct LTE_RACH_ConfigCommon_NB_r13, connEstFailOffset_r13),
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_RACH_ConfigCommon_NB_r13, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_LTE_ext1_7,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_RACH_ConfigCommon_NB_r13, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_LTE_ext2_9,
		0,
...
static const int asn_MAP_LTE_RACH_ConfigCommon_NB_r13_oms_1[] = { 3, 4, 5 };
