...
static asn_TYPE_member_t asn_MBR_LTE_ext1_15[] = {
	{ ATF_POINTER, 2, offsetof(struct LTE_SL_PSSCH_TxConfig_r14__ext1, parametersAboveThres_v1530),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_SL_PSSCH_TxParameters_v1530,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"parametersAboveThres-v1530"
		},
	{ ATF_POINTER, 1, offsetof(struct LTE_SL_PSSCH_TxConfig_r14__ext1, parametersBelowThres_v1530),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_SL_PSSCH_TxParameters_v1530,
		0,
...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_ext1_specs_15 = {
	sizeof(struct LTE_SL_PSSCH_TxConfig_r14__ext1),
	offsetof(struct LTE_SL_PSSCH_TxConfig_r14__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LTE_SL_PSSCH_TxConfig_r14_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_SL_PSSCH_TxConfig_r14, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_LTE_ext1_15,
		0,
...
static const int asn_MAP_LTE_SL_PSSCH_TxConfig_r14_oms_1[] = { 0, 4 };
