...
static asn_per_constraints_t asn_PER_type_LTE_idc_Indication_MRDC_r15_constr_31 CC_NOTUSED = {
...
static asn_TYPE_member_t asn_MBR_LTE_idc_Indication_MRDC_r15_31[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_IDC_Config_r11__ext3__idc_Indication_MRDC_r15, choice.release),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NULL,
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LTE_IDC_Config_r11__ext3__idc_Indication_MRDC_r15, choice.setup),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_LTE_CandidateServingFreqListNR_r15,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"setup"
...
static const asn_TYPE_tag2member_t asn_MAP_LTE_idc_Indication_MRDC_r15_tag2el_31[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* release */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* setup */
};
static asn_CHOICE_specifics_t asn_SPC_LTE_idc_Indication_MRDC_r15_specs_31 = {
	sizeof(struct LTE_IDC_Config_r11__ext3__idc_Indication_MRDC_r15),
	offsetof(struct LTE_IDC_Config_r11__ext3__idc_Indication_MRDC_r15, _asn_ctx),
	offsetof(struct LTE_IDC_Config_r11__ext3__idc_Indication_MRDC_r15, present),
	sizeof(((struct LTE_IDC_Config_r11__ext3__idc_Indication_MRDC_r15 *)0)->present),
	asn_MAP_LTE_idc_Indication_MRDC_r15_tag2el_31,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LTE_idc_Indication_MRDC_r15_31 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_LTE_idc_Indication_MRDC_r15_constr_31, CHOICE_constraint },
	asn_MBR_LTE_idc_Indication_MRDC_r15_31,
	2,	/* Elements count */
	&asn_SPC_LTE_idc_Indication_MRDC_r15_specs_31	/* Additional specs */
};

static asn_TYPE_member_t asn_MBR_LTE_ext3_30[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_IDC_Config_r11__ext3, idc_Indication_MRDC_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
		&asn_DEF_LTE_idc_Indication_MRDC_r15_31,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"idc-Indication-MRDC-r15"
...
static const int asn_MAP_LTE_ext3_oms_30[] = { 0 };
static const ber_tlv_tag_t asn_DEF_LTE_ext3_tags_30[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_LTE_ext3_tag2el_30[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* idc-Indication-MRDC-r15 */
};
static asn_SEQUENCE_specifics_t asn_SPC_LTE_ext3_specs_30 = {
	sizeof(struct LTE_IDC_Config_r11__ext3),
	offsetof(struct LTE_IDC_Config_r11__ext3, _asn_ctx),
	asn_MAP_LTE_ext3_tag2el_30,
	1,	/* Count of tags in the map */
	asn_MAP_LTE_ext3_oms_30,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LTE_ext3_30 = {
	"ext3",
	"ext3",
	&asn_OP_SEQUENCE,
	asn_DEF_LTE_ext3_tags_30,
	sizeof(asn_DEF_LTE_ext3_tags_30)
		/sizeof(asn_DEF_LTE_ext3_tags_30[0]) - 1, /* 1 */
	asn_DEF_LTE_ext3_tags_30,	/* Same as above */
	sizeof(asn_DEF_LTE_ext3_tags_30)
		/sizeof(asn_DEF_LTE_ext3_tags_30[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_LTE_ext3_30,
	1,	/* Elements count */
	&asn_SPC_LTE_ext3_specs_30	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_LTE_IDC_Config_r11_1[] = {
	{ ATF_POINTER, 5, offsetof(struct LTE_IDC_Config_r11, idc_Indication_r11),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct LTE_IDC_Config_r11, autonomousDenialParameters_r11),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct LTE_IDC_Config_r11, ext1),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_LTE_ext1_24,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_IDC_Config_r11, ext2),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_LTE_ext2_27,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_IDC_Config_r11, ext3),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_LTE_ext3_30,
		0,
...
static const int asn_MAP_LTE_IDC_Config_r11_oms_1[] = { 0, 1, 2, 3, 4 };
