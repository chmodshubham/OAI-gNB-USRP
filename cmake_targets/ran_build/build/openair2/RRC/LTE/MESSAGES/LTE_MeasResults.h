...
struct LTE_MeasResultServFreqListNR_r15;
struct LTE_MeasResultCellListSFTD_r15;
struct LTE_LogMeasResultListBT_r15;
struct LTE_LogMeasResultListWLAN_r15;
struct LTE_MeasResultSensing_r15;
...
typedef struct LTE_MeasResults {
	...
	struct LTE_MeasResults__measResultNeighCells {
		...
		union LTE_MeasResults__LTE_measResultNeighCells_u {
			 ...
			 */
			LTE_MeasResultCellListNR_r15_t	 measResultNeighCellListNR_r15;
		} choice;
	...
	struct LTE_MeasResults__ext7 {
		struct LTE_MeasResultServFreqListNR_r15	*measResultServFreqListNR_r15;	/* OPTIONAL */
		struct LTE_MeasResultCellListSFTD_r15	*measResultCellListSFTD_r15;	/* OPTIONAL */
		
		/* Context for parsing across buffer boundaries */
		asn_struct_ctx_t _asn_ctx;
	} *ext7;
	struct LTE_MeasResults__ext8 {
		...
		struct LTE_MeasResultSensing_r15	*measResultSensing_r15;	/* OPTIONAL */
...
extern asn_TYPE_member_t asn_MBR_LTE_MeasResults_1[11];
