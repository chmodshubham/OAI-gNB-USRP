...
static asn_TYPE_member_t asn_MBR_LTE_ext2_19[] = {
	{ ATF_POINTER, 1, offsetof(struct LTE_SL_InterFreqInfoV2X_r14__ext2, v2x_FreqSelectionConfigList_r15),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static asn_SEQUENCE_specifics_t asn_SPC_LTE_ext2_specs_19 = {
	sizeof(struct LTE_SL_InterFreqInfoV2X_r14__ext2),
	offsetof(struct LTE_SL_InterFreqInfoV2X_r14__ext2, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_LTE_SL_InterFreqInfoV2X_r14_1[] = {
	...
	{ ATF_POINTER, 6, offsetof(struct LTE_SL_InterFreqInfoV2X_r14, sl_MaxTxPower_r14),
	...
	{ ATF_POINTER, 5, offsetof(struct LTE_SL_InterFreqInfoV2X_r14, sl_Bandwidth_r14),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct LTE_SL_InterFreqInfoV2X_r14, v2x_SchedulingPool_r14),
	...
	{ ATF_POINTER, 3, offsetof(struct LTE_SL_InterFreqInfoV2X_r14, v2x_UE_ConfigList_r14),
	...
	{ ATF_POINTER, 2, offsetof(struct LTE_SL_InterFreqInfoV2X_r14, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_LTE_ext1_15,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct LTE_SL_InterFreqInfoV2X_r14, ext2),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_LTE_ext2_19,
		0,
...
static const int asn_MAP_LTE_SL_InterFreqInfoV2X_r14_oms_1[] = { 0, 2, 3, 4, 5, 6, 7 };
