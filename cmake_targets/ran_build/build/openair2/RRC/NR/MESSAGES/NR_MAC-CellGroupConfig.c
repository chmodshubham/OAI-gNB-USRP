...
asn_TYPE_descriptor_t asn_DEF_NR_enhancedSkipUplinkTxDynamic_r16_21 = {
	...
	{ 0, &asn_PER_type_NR_enhancedSkipUplinkTxDynamic_r16_constr_21, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_NR_enhancedSkipUplinkTxConfigured_r16_23 = {
	...
	{ 0, &asn_PER_type_NR_enhancedSkipUplinkTxConfigured_r16_constr_23, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_NR_MAC_CellGroupConfig_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct NR_MAC_CellGroupConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_NR_ext1_9,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct NR_MAC_CellGroupConfig, ext2),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_NR_ext2_12,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NR_MAC_CellGroupConfig, ext3),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_NR_ext3_20,
		0,
...
static const int asn_MAP_NR_MAC_CellGroupConfig_oms_1[] = { 0, 1, 2, 3, 4, 6, 7, 8 };
