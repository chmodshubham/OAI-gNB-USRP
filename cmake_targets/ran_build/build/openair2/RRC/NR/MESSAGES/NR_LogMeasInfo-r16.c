...
asn_TYPE_descriptor_t asn_DEF_NR_anyCellSelectionDetected_r16_9 = {
	...
	{ 0, &asn_PER_type_NR_anyCellSelectionDetected_r16_constr_9, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_NR_LogMeasInfo_r16_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_LogMeasInfo_r16, relativeTimeStamp_r16),
		...
		0,
		{ 0, &asn_PER_memb_NR_relativeTimeStamp_r16_constr_3,  memb_NR_relativeTimeStamp_r16_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_LogMeasInfo_r16, anyCellSelectionDetected_r16),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_NR_LogMeasInfo_r16_oms_1[] = { 0, 2, 3, 5 };
