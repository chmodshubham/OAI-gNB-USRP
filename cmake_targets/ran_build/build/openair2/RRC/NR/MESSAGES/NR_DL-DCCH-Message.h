...
#ifndef	_NR_DL_DCCH_Message_H_
#define	_NR_DL_DCCH_Message_H_
...
/* NR_DL-DCCH-Message */
typedef struct NR_DL_DCCH_Message {
	NR_DL_DCCH_MessageType_t	 message;
