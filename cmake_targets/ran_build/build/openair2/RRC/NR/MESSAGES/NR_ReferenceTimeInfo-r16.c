...
asn_TYPE_descriptor_t asn_DEF_NR_timeInfoType_r16_4 = {
	...
	{ 0, &asn_PER_type_NR_timeInfoType_r16_constr_4, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_NR_ReferenceTimeInfo_r16_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct NR_ReferenceTimeInfo_r16, uncertainty_r16),
		...
		0,
		{ 0, &asn_PER_memb_NR_uncertainty_r16_constr_3,  memb_NR_uncertainty_r16_constraint_1 },
		0, 0, /* No default value */
		"uncertainty-r16"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct NR_ReferenceTimeInfo_r16, referenceSFN_r16),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_referenceSFN_r16_constr_6,  memb_NR_referenceSFN_r16_constraint_1 },
		0, 0, /* No default value */
		"referenceSFN-r16"
		},
};
