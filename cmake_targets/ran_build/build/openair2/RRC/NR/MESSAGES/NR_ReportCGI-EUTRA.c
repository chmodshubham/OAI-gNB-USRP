...
static asn_TYPE_member_t asn_MBR_NR_ext1_4[] = {
	{ ATF_POINTER, 1, offsetof(struct NR_ReportCGI_EUTRA__ext1, useAutonomousGaps_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static asn_SEQUENCE_specifics_t asn_SPC_NR_ext1_specs_4 = {
	sizeof(struct NR_ReportCGI_EUTRA__ext1),
	offsetof(struct NR_ReportCGI_EUTRA__ext1, _asn_ctx),
...
asn_TYPE_member_t asn_MBR_NR_ReportCGI_EUTRA_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NR_ReportCGI_EUTRA, cellForWhichToReportCGI),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_ReportCGI_EUTRA, ext1),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_NR_ext1_4,
		0,
...
static const int asn_MAP_NR_ReportCGI_EUTRA_oms_1[] = { 1 };
static const ber_tlv_tag_t asn_DEF_NR_ReportCGI_EUTRA_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_ReportCGI_EUTRA_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* cellForWhichToReportCGI */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* ext1 */
};
asn_SEQUENCE_specifics_t asn_SPC_NR_ReportCGI_EUTRA_specs_1 = {
	sizeof(struct NR_ReportCGI_EUTRA),
	offsetof(struct NR_ReportCGI_EUTRA, _asn_ctx),
	asn_MAP_NR_ReportCGI_EUTRA_tag2el_1,
	2,	/* Count of tags in the map */
	asn_MAP_NR_ReportCGI_EUTRA_oms_1,	/* Optional members */
	0, 1,	/* Root/Additions */
	1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_NR_ReportCGI_EUTRA = {
	"ReportCGI-EUTRA",
	"ReportCGI-EUTRA",
	&asn_OP_SEQUENCE,
	asn_DEF_NR_ReportCGI_EUTRA_tags_1,
	sizeof(asn_DEF_NR_ReportCGI_EUTRA_tags_1)
		/sizeof(asn_DEF_NR_ReportCGI_EUTRA_tags_1[0]), /* 1 */
	asn_DEF_NR_ReportCGI_EUTRA_tags_1,	/* Same as above */
	sizeof(asn_DEF_NR_ReportCGI_EUTRA_tags_1)
		/sizeof(asn_DEF_NR_ReportCGI_EUTRA_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_NR_ReportCGI_EUTRA_1,
	2,	/* Elements count */
	&asn_SPC_NR_ReportCGI_EUTRA_specs_1	/* Additional specs */
};
