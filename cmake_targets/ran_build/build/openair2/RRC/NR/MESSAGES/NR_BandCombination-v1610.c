...
static asn_per_constraints_t asn_PER_type_NR_powerClassNRPart_r16_constr_8 CC_NOTUSED = {
...
static const asn_INTEGER_enum_map_t asn_MAP_NR_powerClassNRPart_r16_value2enum_8[] = {
	{ 0,	3,	"pc1" },
	{ 1,	3,	"pc2" },
	{ 2,	3,	"pc3" },
	{ 3,	3,	"pc5" }
};
static const unsigned int asn_MAP_NR_powerClassNRPart_r16_enum2value_8[] = {
	0,	/* pc1(0) */
	1,	/* pc2(1) */
	2,	/* pc3(2) */
	3	/* pc5(3) */
};
static const asn_INTEGER_specifics_t asn_SPC_NR_powerClassNRPart_r16_specs_8 = {
	asn_MAP_NR_powerClassNRPart_r16_value2enum_8,	/* "tag" => N; sorted by tag */
	asn_MAP_NR_powerClassNRPart_r16_enum2value_8,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_NR_powerClassNRPart_r16_tags_8[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_NR_powerClassNRPart_r16_8 = {
	"powerClassNRPart-r16",
	"powerClassNRPart-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_NR_powerClassNRPart_r16_tags_8,
	sizeof(asn_DEF_NR_powerClassNRPart_r16_tags_8)
		/sizeof(asn_DEF_NR_powerClassNRPart_r16_tags_8[0]) - 1, /* 1 */
	asn_DEF_NR_powerClassNRPart_r16_tags_8,	/* Same as above */
	sizeof(asn_DEF_NR_powerClassNRPart_r16_tags_8)
		/sizeof(asn_DEF_NR_powerClassNRPart_r16_tags_8[0]), /* 2 */
	{ 0, &asn_PER_type_NR_powerClassNRPart_r16_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_NR_powerClassNRPart_r16_specs_8	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_NR_BandCombination_v1610_1[] = {
	{ ATF_POINTER, 7, offsetof(struct NR_BandCombination_v1610, bandList_v1610),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 6, offsetof(struct NR_BandCombination_v1610, ca_ParametersNR_v1610),
	...
	{ ATF_POINTER, 5, offsetof(struct NR_BandCombination_v1610, ca_ParametersNRDC_v1610),
	...
	{ ATF_POINTER, 4, offsetof(struct NR_BandCombination_v1610, powerClass_v1610),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct NR_BandCombination_v1610, powerClassNRPart_r16),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_powerClassNRPart_r16_8,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"powerClassNRPart-r16"
		},
	{ ATF_POINTER, 2, offsetof(struct NR_BandCombination_v1610, featureSetCombinationDAPS_r16),
	...
	{ ATF_POINTER, 1, offsetof(struct NR_BandCombination_v1610, mrdc_Parameters_v1620),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_MRDC_Parameters_v1620,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
...
static const int asn_MAP_NR_BandCombination_v1610_oms_1[] = { 0, 1, 2, 3, 4, 5, 6 };
