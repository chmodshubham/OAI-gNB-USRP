...
asn_TYPE_descriptor_t asn_DEF_NR_maxNumberCORESET_r16_2 = {
	...
	{ 0, &asn_PER_type_NR_maxNumberCORESET_r16_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_maxNumberUnicastPDSCH_PerPool_r16_8 = {
	...
	{ 0, &asn_PER_type_NR_maxNumberUnicastPDSCH_PerPool_r16_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_NR_MultiDCI_MultiTRP_r16_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_MultiDCI_MultiTRP_r16, maxNumberCORESETPerPoolIndex_r16),
		...
		0,
		{ 0, &asn_PER_memb_NR_maxNumberCORESETPerPoolIndex_r16_constr_7,  memb_NR_maxNumberCORESETPerPoolIndex_r16_constraint_1 },
		0, 0, /* No default value */
