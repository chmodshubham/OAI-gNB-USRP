...
asn_TYPE_descriptor_t asn_DEF_NR_cgi_info_EPC_list_4 = {
	...
	{ 0, &asn_PER_type_NR_cgi_info_EPC_list_constr_4, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_NR_cgi_info_EPC_2[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NR_CGI_InfoEUTRA__cgi_info_EPC, cgi_info_EPC_list),
		...
		0,
		{ 0, &asn_PER_memb_NR_cgi_info_EPC_list_constr_4,  memb_NR_cgi_info_EPC_list_constraint_2 },
		0, 0, /* No default value */
		"cgi-info-EPC-list"
		},
};
...
asn_TYPE_descriptor_t asn_DEF_NR_cgi_info_5GC_6 = {
	...
	{ 0, &asn_PER_type_NR_cgi_info_5GC_constr_6, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_freqBandIndicatorPriority_10 = {
	...
	{ 0, &asn_PER_type_NR_freqBandIndicatorPriority_constr_10, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_NR_CGI_InfoEUTRA_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NR_CGI_InfoEUTRA, cgi_info_5GC),
		...
		0,
		{ 0, &asn_PER_memb_NR_cgi_info_5GC_constr_6,  memb_NR_cgi_info_5GC_constraint_1 },
		0, 0, /* No default value */
		"cgi-info-5GC"
		},
