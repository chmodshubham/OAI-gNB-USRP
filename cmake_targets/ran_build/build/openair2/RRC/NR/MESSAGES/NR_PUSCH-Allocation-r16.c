...
asn_TYPE_descriptor_t asn_DEF_NR_mappingType_r16_2 = {
	...
	{ 0, &asn_PER_type_NR_mappingType_r16_constr_2, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_numberOfRepetitions_r16_8 = {
	...
	{ 0, &asn_PER_type_NR_numberOfRepetitions_r16_constr_8, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_NR_numberOfRepetitions_r16_specs_8	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_NR_PUSCH_Allocation_r16_1[] = {
	{ ATF_POINTER, 5, offsetof(struct NR_PUSCH_Allocation_r16, mappingType_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_POINTER, 4, offsetof(struct NR_PUSCH_Allocation_r16, startSymbolAndLength_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_startSymbolAndLength_r16_constr_5,  memb_NR_startSymbolAndLength_r16_constraint_1 },
		0, 0, /* No default value */
		"startSymbolAndLength-r16"
		},
	{ ATF_POINTER, 3, offsetof(struct NR_PUSCH_Allocation_r16, startSymbol_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_startSymbol_r16_constr_6,  memb_NR_startSymbol_r16_constraint_1 },
		0, 0, /* No default value */
		"startSymbol-r16"
		},
	{ ATF_POINTER, 2, offsetof(struct NR_PUSCH_Allocation_r16, length_r16),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_length_r16_constr_7,  memb_NR_length_r16_constraint_1 },
		0, 0, /* No default value */
		"length-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct NR_PUSCH_Allocation_r16, numberOfRepetitions_r16),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_NR_PUSCH_Allocation_r16_oms_1[] = { 0, 1, 2, 3, 4 };
