...
asn_TYPE_descriptor_t asn_DEF_NR_mappingType_r16_3 = {
	...
	{ 0, &asn_PER_type_NR_mappingType_r16_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_repetitionNumber_r16_7 = {
	...
	{ 0, &asn_PER_type_NR_repetitionNumber_r16_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_NR_PDSCH_TimeDomainResourceAllocation_r16_1[] = {
	{ ATF_POINTER, 1, offsetof(struct NR_PDSCH_TimeDomainResourceAllocation_r16, k0_r16),
		...
		0,
		{ 0, &asn_PER_memb_NR_k0_r16_constr_2,  memb_NR_k0_r16_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_PDSCH_TimeDomainResourceAllocation_r16, startSymbolAndLength_r16),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_startSymbolAndLength_r16_constr_6,  memb_NR_startSymbolAndLength_r16_constraint_1 },
		0, 0, /* No default value */
		"startSymbolAndLength-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct NR_PDSCH_TimeDomainResourceAllocation_r16, repetitionNumber_r16),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_NR_PDSCH_TimeDomainResourceAllocation_r16_oms_1[] = { 0, 3 };
