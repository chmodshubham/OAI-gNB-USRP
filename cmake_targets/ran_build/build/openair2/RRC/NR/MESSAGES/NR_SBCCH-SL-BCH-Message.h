...
#ifndef	_NR_SBCCH_SL_BCH_Message_H_
#define	_NR_SBCCH_SL_BCH_Message_H_
...
/* NR_SBCCH-SL-BCH-Message */
typedef struct NR_SBCCH_SL_BCH_Message {
	NR_SBCCH_SL_BCH_MessageType_t	 message;
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} NR_SBCCH_SL_BCH_Message_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_NR_SBCCH_SL_BCH_Message;

#ifdef __cplusplus
}
#endif

#endif	/* _NR_SBCCH_SL_BCH_Message_H_ */
