...
static asn_per_constraints_t asn_PER_memb_NR_channelOccupancy_r16_constr_3 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_NR_MeasResultForRSSI_r16_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_MeasResultForRSSI_r16, channelOccupancy_r16),
		...
		0,
		{ 0, &asn_PER_memb_NR_channelOccupancy_r16_constr_3,  memb_NR_channelOccupancy_r16_constraint_1 },
		0, 0, /* No default value */
