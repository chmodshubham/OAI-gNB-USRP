...
asn_TYPE_descriptor_t asn_DEF_NR_supportedBandPairListNR_r16_9 = {
	...
	{ 0, &asn_PER_type_NR_supportedBandPairListNR_r16_constr_9, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_uplinkTxSwitching_OptionSupport_r16_11 = {
	...
	{ 0, &asn_PER_type_NR_uplinkTxSwitching_OptionSupport_r16_constr_11, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_uplinkTxSwitching_PowerBoosting_r16_15 = {
	...
	{ 0, &asn_PER_type_NR_uplinkTxSwitching_PowerBoosting_r16_constr_15, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_NR_BandCombination_UplinkTxSwitch_r16_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_BandCombination_UplinkTxSwitch_r16, supportedBandPairListNR_r16),
		...
		0,
		{ 0, &asn_PER_memb_NR_supportedBandPairListNR_r16_constr_9,  memb_NR_supportedBandPairListNR_r16_constraint_1 },
		0, 0, /* No default value */
		"supportedBandPairListNR-r16"
		},
	{ ATF_POINTER, 2, offsetof(struct NR_BandCombination_UplinkTxSwitch_r16, uplinkTxSwitching_OptionSupport_r16),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_BandCombination_UplinkTxSwitch_r16, uplinkTxSwitching_PowerBoosting_r16),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		-1,	/* IMPLICIT tag at current level */
...
static const int asn_MAP_NR_BandCombination_UplinkTxSwitch_r16_oms_1[] = { 1, 2, 3, 4, 5, 6, 8, 9 };
