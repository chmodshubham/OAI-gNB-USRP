...
asn_TYPE_descriptor_t asn_DEF_NR_supportedBandListNR_2 = {
	...
	{ 0, &asn_PER_type_NR_supportedBandListNR_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_srs_SwitchingTimeRequested_9 = {
	...
	{ 0, &asn_PER_type_NR_srs_SwitchingTimeRequested_constr_9, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_NR_RF_Parameters_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NR_RF_Parameters, supportedBandListNR),
		...
		0,
		{ 0, &asn_PER_memb_NR_supportedBandListNR_constr_2,  memb_NR_supportedBandListNR_constraint_1 },
		0, 0, /* No default value */
		"supportedBandListNR"
		},
	{ ATF_POINTER, 8, offsetof(struct NR_RF_Parameters, supportedBandCombinationList),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 7, offsetof(struct NR_RF_Parameters, appliedFreqBandListFilter),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 6, offsetof(struct NR_RF_Parameters, ext1),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
		&asn_DEF_NR_ext1_7,
		0,
	...
	{ ATF_POINTER, 5, offsetof(struct NR_RF_Parameters, ext2),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_NR_ext2_11,
		0,
	...
	{ ATF_POINTER, 4, offsetof(struct NR_RF_Parameters, ext3),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_NR_ext3_13,
		0,
	...
	{ ATF_POINTER, 3, offsetof(struct NR_RF_Parameters, ext4),
		(ASN_TAG_CLASS_CONTEXT | (6 << 2)),
		0,
		&asn_DEF_NR_ext4_15,
		0,
	...
	{ ATF_POINTER, 2, offsetof(struct NR_RF_Parameters, ext5),
		(ASN_TAG_CLASS_CONTEXT | (7 << 2)),
		0,
		&asn_DEF_NR_ext5_19,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NR_RF_Parameters, ext6),
		(ASN_TAG_CLASS_CONTEXT | (8 << 2)),
		0,
		&asn_DEF_NR_ext6_23,
		0,
...
static const int asn_MAP_NR_RF_Parameters_oms_1[] = { 1, 2, 3, 4, 5, 6, 7, 8 };
