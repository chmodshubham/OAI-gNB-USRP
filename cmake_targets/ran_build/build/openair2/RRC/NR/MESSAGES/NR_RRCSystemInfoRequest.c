...
static asn_SEQUENCE_specifics_t asn_SPC_NR_criticalExtensionsFuture_specs_6 = {
	sizeof(struct NR_RRCSystemInfoRequest__criticalExtensions__criticalExtensionsFuture_r16__criticalExtensionsFuture),
	offsetof(struct NR_RRCSystemInfoRequest__criticalExtensions__criticalExtensionsFuture_r16__criticalExtensionsFuture, _asn_ctx),
	0,	/* No top level tags */
...
static asn_TYPE_member_t asn_MBR_NR_criticalExtensionsFuture_r16_4[] = {
	{ ATF_POINTER, 0, offsetof(struct NR_RRCSystemInfoRequest__criticalExtensions__criticalExtensionsFuture_r16, choice.rrcPosSystemInfoRequest_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_RRC_PosSystemInfoRequest_r16_IEs,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"rrcPosSystemInfoRequest-r16"
		},
	{ ATF_POINTER, 0, offsetof(struct NR_RRCSystemInfoRequest__criticalExtensions__criticalExtensionsFuture_r16, choice.criticalExtensionsFuture),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
...
static asn_CHOICE_specifics_t asn_SPC_NR_criticalExtensionsFuture_r16_specs_4 = {
	sizeof(struct NR_RRCSystemInfoRequest__criticalExtensions__criticalExtensionsFuture_r16),
	offsetof(struct NR_RRCSystemInfoRequest__criticalExtensions__criticalExtensionsFuture_r16, _asn_ctx),
	offsetof(struct NR_RRCSystemInfoRequest__criticalExtensions__criticalExtensionsFuture_r16, present),
	sizeof(((struct NR_RRCSystemInfoRequest__criticalExtensions__criticalExtensionsFuture_r16 *)0)->present),
...
static asn_TYPE_member_t asn_MBR_NR_criticalExtensions_2[] = {
	{ ATF_POINTER, 0, offsetof(struct NR_RRCSystemInfoRequest__criticalExtensions, choice.rrcSystemInfoRequest),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_RRCSystemInfoRequest_IEs,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"rrcSystemInfoRequest"
		},
	{ ATF_POINTER, 0, offsetof(struct NR_RRCSystemInfoRequest__criticalExtensions, choice.criticalExtensionsFuture_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
...
static asn_CHOICE_specifics_t asn_SPC_NR_criticalExtensions_specs_2 = {
	sizeof(struct NR_RRCSystemInfoRequest__criticalExtensions),
	offsetof(struct NR_RRCSystemInfoRequest__criticalExtensions, _asn_ctx),
	offsetof(struct NR_RRCSystemInfoRequest__criticalExtensions, present),
	sizeof(((struct NR_RRCSystemInfoRequest__criticalExtensions *)0)->present),
...
asn_TYPE_member_t asn_MBR_NR_RRCSystemInfoRequest_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NR_RRCSystemInfoRequest, criticalExtensions),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
...
static const ber_tlv_tag_t asn_DEF_NR_RRCSystemInfoRequest_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_RRCSystemInfoRequest_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* criticalExtensions */
};
asn_SEQUENCE_specifics_t asn_SPC_NR_RRCSystemInfoRequest_specs_1 = {
	sizeof(struct NR_RRCSystemInfoRequest),
	offsetof(struct NR_RRCSystemInfoRequest, _asn_ctx),
	asn_MAP_NR_RRCSystemInfoRequest_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_NR_RRCSystemInfoRequest = {
	"RRCSystemInfoRequest",
	"RRCSystemInfoRequest",
	&asn_OP_SEQUENCE,
	asn_DEF_NR_RRCSystemInfoRequest_tags_1,
	sizeof(asn_DEF_NR_RRCSystemInfoRequest_tags_1)
		/sizeof(asn_DEF_NR_RRCSystemInfoRequest_tags_1[0]), /* 1 */
	asn_DEF_NR_RRCSystemInfoRequest_tags_1,	/* Same as above */
	sizeof(asn_DEF_NR_RRCSystemInfoRequest_tags_1)
		/sizeof(asn_DEF_NR_RRCSystemInfoRequest_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_NR_RRCSystemInfoRequest_1,
	1,	/* Elements count */
	&asn_SPC_NR_RRCSystemInfoRequest_specs_1	/* Additional specs */
};
