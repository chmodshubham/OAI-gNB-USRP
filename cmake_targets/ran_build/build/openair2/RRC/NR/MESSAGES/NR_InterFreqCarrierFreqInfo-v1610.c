...
asn_TYPE_descriptor_t asn_DEF_NR_interFreqCAG_CellList_r16_6 = {
	...
	{ 0, &asn_PER_type_NR_interFreqCAG_CellList_r16_constr_6, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_NR_InterFreqCarrierFreqInfo_v1610_1[] = {
	...
	{ ATF_POINTER, 3, offsetof(struct NR_InterFreqCarrierFreqInfo_v1610, interFreqWhiteCellList_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_InterFreqWhiteCellList_r16,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_InterFreqCarrierFreqInfo_v1610, interFreqCAG_CellList_r16),
		...
		0,
		{ 0, &asn_PER_memb_NR_interFreqCAG_CellList_r16_constr_6,  memb_NR_interFreqCAG_CellList_r16_constraint_1 },
		0, 0, /* No default value */
		"interFreqCAG-CellList-r16"
		},
};
