...
#ifndef	_NR_EUTRA_Cell_H_
#define	_NR_EUTRA_Cell_H_
...
/* NR_EUTRA-Cell */
typedef struct NR_EUTRA_Cell {
	NR_EUTRA_CellIndex_t	 cellIndexEUTRA;
	NR_EUTRA_PhysCellId_t	 physCellId;
	NR_EUTRA_Q_OffsetRange_t	 cellIndividualOffset;
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_NR_EUTRA_Cell;
extern asn_SEQUENCE_specifics_t asn_SPC_NR_EUTRA_Cell_specs_1;
extern asn_TYPE_member_t asn_MBR_NR_EUTRA_Cell_1[3];

#ifdef __cplusplus
}
#endif

#endif	/* _NR_EUTRA_Cell_H_ */
