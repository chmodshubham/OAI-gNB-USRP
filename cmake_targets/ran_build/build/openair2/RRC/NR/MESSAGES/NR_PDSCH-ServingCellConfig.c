...
asn_TYPE_descriptor_t asn_DEF_NR_xOverhead_3 = {
	...
	{ 0, &asn_PER_type_NR_xOverhead_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_nrofHARQ_ProcessesForPDSCH_7 = {
	...
	{ 0, &asn_PER_type_NR_nrofHARQ_ProcessesForPDSCH_constr_7, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
static asn_TYPE_member_t asn_MBR_NR_ext1_16[] = {
	{ ATF_POINTER, 2, offsetof(struct NR_PDSCH_ServingCellConfig__ext1, maxMIMO_Layers),
		...
		0,
		{ 0, &asn_PER_memb_NR_maxMIMO_Layers_constr_17,  memb_NR_maxMIMO_Layers_constraint_16 },
...
asn_TYPE_member_t asn_MBR_NR_PDSCH_ServingCellConfig_1[] = {
	{ ATF_POINTER, 6, offsetof(struct NR_PDSCH_ServingCellConfig, codeBlockGroupTransmission),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		+1,	/* EXPLICIT tag at current level */
	...
	{ ATF_POINTER, 5, offsetof(struct NR_PDSCH_ServingCellConfig, xOverhead),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 4, offsetof(struct NR_PDSCH_ServingCellConfig, nrofHARQ_ProcessesForPDSCH),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
	...
	{ ATF_POINTER, 3, offsetof(struct NR_PDSCH_ServingCellConfig, pucch_Cell),
	...
	{ ATF_POINTER, 2, offsetof(struct NR_PDSCH_ServingCellConfig, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_NR_ext1_16,
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NR_PDSCH_ServingCellConfig, ext2),
		(ASN_TAG_CLASS_CONTEXT | (5 << 2)),
		0,
		&asn_DEF_NR_ext2_19,
		0,
...
static const int asn_MAP_NR_PDSCH_ServingCellConfig_oms_1[] = { 0, 1, 2, 3, 4, 5 };
