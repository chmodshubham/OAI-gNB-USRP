...
asn_TYPE_descriptor_t asn_DEF_NR_condExecutionCond_r16_3 = {
	...
	{ 0, &asn_PER_type_NR_condExecutionCond_r16_constr_3, SEQUENCE_OF_constraint },
...
asn_TYPE_member_t asn_MBR_NR_CondReconfigToAddMod_r16_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NR_CondReconfigToAddMod_r16, condExecutionCond_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_NR_condExecutionCond_r16_3,
		0,
		{ 0, &asn_PER_memb_NR_condExecutionCond_r16_constr_3,  memb_NR_condExecutionCond_r16_constraint_1 },
		0, 0, /* No default value */
		"condExecutionCond-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct NR_CondReconfigToAddMod_r16, condRRCReconfig_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_OCTET_STRING,
		0,
		{ 0, &asn_PER_memb_NR_condRRCReconfig_r16_constr_5,  memb_NR_condRRCReconfig_r16_constraint_1 },
		0, 0, /* No default value */
		"condRRCReconfig-r16"
		},
};
static const int asn_MAP_NR_CondReconfigToAddMod_r16_oms_1[] = { 1, 2 };
