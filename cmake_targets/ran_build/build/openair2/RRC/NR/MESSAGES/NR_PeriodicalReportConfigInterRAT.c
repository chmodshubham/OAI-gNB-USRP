...
asn_TYPE_descriptor_t asn_DEF_NR_reportAmount_3 = {
	...
	{ 0, &asn_PER_type_NR_reportAmount_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_NR_PeriodicalReportConfigInterRAT_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_PeriodicalReportConfigInterRAT, maxReportCells),
		...
		0,
		{ 0, &asn_PER_memb_NR_maxReportCells_constr_13,  memb_NR_maxReportCells_constraint_1 },
		0, 0, /* No default value */
		"maxReportCells"
		},
	{ ATF_POINTER, 1, offsetof(struct NR_PeriodicalReportConfigInterRAT, ext1),
		(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
		0,
		&asn_DEF_NR_ext1_15,
		0,
...
static const int asn_MAP_NR_PeriodicalReportConfigInterRAT_oms_1[] = { 4 };
