...
#include "NR_VarMeasIdleConfig-r16.h"
...
static asn_SET_OF_specifics_t asn_SPC_NR_measIdleCarrierListNR_r16_specs_2 = {
	sizeof(struct NR_VarMeasIdleConfig_r16__measIdleCarrierListNR_r16),
	offsetof(struct NR_VarMeasIdleConfig_r16__measIdleCarrierListNR_r16, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_NR_measIdleCarrierListEUTRA_r16_specs_4 = {
	sizeof(struct NR_VarMeasIdleConfig_r16__measIdleCarrierListEUTRA_r16),
	offsetof(struct NR_VarMeasIdleConfig_r16__measIdleCarrierListEUTRA_r16, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static asn_TYPE_member_t asn_MBR_NR_VarMeasIdleConfig_r16_1[] = {
	{ ATF_POINTER, 2, offsetof(struct NR_VarMeasIdleConfig_r16, measIdleCarrierListNR_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NR_VarMeasIdleConfig_r16, measIdleCarrierListEUTRA_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_VarMeasIdleConfig_r16, measIdleDuration_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	...
	{ ATF_POINTER, 1, offsetof(struct NR_VarMeasIdleConfig_r16, validityAreaList_r16),
...
static const int asn_MAP_NR_VarMeasIdleConfig_r16_oms_1[] = { 0, 1, 3 };
static const ber_tlv_tag_t asn_DEF_NR_VarMeasIdleConfig_r16_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_VarMeasIdleConfig_r16_tag2el_1[] = {
...
static asn_SEQUENCE_specifics_t asn_SPC_NR_VarMeasIdleConfig_r16_specs_1 = {
	sizeof(struct NR_VarMeasIdleConfig_r16),
	offsetof(struct NR_VarMeasIdleConfig_r16, _asn_ctx),
	asn_MAP_NR_VarMeasIdleConfig_r16_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_NR_VarMeasIdleConfig_r16_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_NR_VarMeasIdleConfig_r16 = {
	"VarMeasIdleConfig-r16",
	"VarMeasIdleConfig-r16",
	&asn_OP_SEQUENCE,
	asn_DEF_NR_VarMeasIdleConfig_r16_tags_1,
	sizeof(asn_DEF_NR_VarMeasIdleConfig_r16_tags_1)
		/sizeof(asn_DEF_NR_VarMeasIdleConfig_r16_tags_1[0]), /* 1 */
	asn_DEF_NR_VarMeasIdleConfig_r16_tags_1,	/* Same as above */
	sizeof(asn_DEF_NR_VarMeasIdleConfig_r16_tags_1)
		/sizeof(asn_DEF_NR_VarMeasIdleConfig_r16_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_NR_VarMeasIdleConfig_r16_1,
	4,	/* Elements count */
	&asn_SPC_NR_VarMeasIdleConfig_r16_specs_1	/* Additional specs */
};
