...
static asn_per_constraints_t asn_PER_type_NR_measIdleDuration_r16_constr_6 CC_NOTUSED = {
...
static asn_SET_OF_specifics_t asn_SPC_NR_measIdleCarrierListNR_r16_specs_2 = {
	sizeof(struct NR_MeasIdleConfigDedicated_r16__measIdleCarrierListNR_r16),
	offsetof(struct NR_MeasIdleConfigDedicated_r16__measIdleCarrierListNR_r16, _asn_ctx),
...
static asn_SET_OF_specifics_t asn_SPC_NR_measIdleCarrierListEUTRA_r16_specs_4 = {
	sizeof(struct NR_MeasIdleConfigDedicated_r16__measIdleCarrierListEUTRA_r16),
	offsetof(struct NR_MeasIdleConfigDedicated_r16__measIdleCarrierListEUTRA_r16, _asn_ctx),
	0,	/* XER encoding is XMLDelimitedItemList */
};
static /* Use -fall-defs-global to expose */
...
static const asn_INTEGER_enum_map_t asn_MAP_NR_measIdleDuration_r16_value2enum_6[] = {
	{ 0,	5,	"sec10" },
	{ 1,	5,	"sec30" },
	{ 2,	5,	"sec60" },
	{ 3,	6,	"sec120" },
...
static const unsigned int asn_MAP_NR_measIdleDuration_r16_enum2value_6[] = {
	0,	/* sec10(0) */
	3,	/* sec120(3) */
	4,	/* sec180(4) */
	5,	/* sec240(5) */
...
static const asn_INTEGER_specifics_t asn_SPC_NR_measIdleDuration_r16_specs_6 = {
	asn_MAP_NR_measIdleDuration_r16_value2enum_6,	/* "tag" => N; sorted by tag */
	asn_MAP_NR_measIdleDuration_r16_enum2value_6,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_NR_measIdleDuration_r16_tags_6[] = {
	(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_NR_measIdleDuration_r16_6 = {
	"measIdleDuration-r16",
	"measIdleDuration-r16",
	&asn_OP_NativeEnumerated,
	asn_DEF_NR_measIdleDuration_r16_tags_6,
	sizeof(asn_DEF_NR_measIdleDuration_r16_tags_6)
		/sizeof(asn_DEF_NR_measIdleDuration_r16_tags_6[0]) - 1, /* 1 */
	asn_DEF_NR_measIdleDuration_r16_tags_6,	/* Same as above */
	sizeof(asn_DEF_NR_measIdleDuration_r16_tags_6)
		/sizeof(asn_DEF_NR_measIdleDuration_r16_tags_6[0]), /* 2 */
	{ 0, &asn_PER_type_NR_measIdleDuration_r16_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_NR_measIdleDuration_r16_specs_6	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_NR_MeasIdleConfigDedicated_r16_1[] = {
	{ ATF_POINTER, 2, offsetof(struct NR_MeasIdleConfigDedicated_r16, measIdleCarrierListNR_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
	...
	{ ATF_POINTER, 1, offsetof(struct NR_MeasIdleConfigDedicated_r16, measIdleCarrierListEUTRA_r16),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_MeasIdleConfigDedicated_r16, measIdleDuration_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_measIdleDuration_r16_6,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"measIdleDuration-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct NR_MeasIdleConfigDedicated_r16, validityAreaList_r16),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NR_ValidityAreaList_r16,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
...
static const int asn_MAP_NR_MeasIdleConfigDedicated_r16_oms_1[] = { 0, 1, 3 };
static const ber_tlv_tag_t asn_DEF_NR_MeasIdleConfigDedicated_r16_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_MeasIdleConfigDedicated_r16_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_NR_MeasIdleConfigDedicated_r16_specs_1 = {
	sizeof(struct NR_MeasIdleConfigDedicated_r16),
	offsetof(struct NR_MeasIdleConfigDedicated_r16, _asn_ctx),
	asn_MAP_NR_MeasIdleConfigDedicated_r16_tag2el_1,
	4,	/* Count of tags in the map */
	asn_MAP_NR_MeasIdleConfigDedicated_r16_oms_1,	/* Optional members */
	3, 0,	/* Root/Additions */
	4,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_NR_MeasIdleConfigDedicated_r16 = {
	"MeasIdleConfigDedicated-r16",
	"MeasIdleConfigDedicated-r16",
	&asn_OP_SEQUENCE,
	asn_DEF_NR_MeasIdleConfigDedicated_r16_tags_1,
	sizeof(asn_DEF_NR_MeasIdleConfigDedicated_r16_tags_1)
		/sizeof(asn_DEF_NR_MeasIdleConfigDedicated_r16_tags_1[0]), /* 1 */
	asn_DEF_NR_MeasIdleConfigDedicated_r16_tags_1,	/* Same as above */
	sizeof(asn_DEF_NR_MeasIdleConfigDedicated_r16_tags_1)
		/sizeof(asn_DEF_NR_MeasIdleConfigDedicated_r16_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_NR_MeasIdleConfigDedicated_r16_1,
	4,	/* Elements count */
	&asn_SPC_NR_MeasIdleConfigDedicated_r16_specs_1	/* Additional specs */
};
