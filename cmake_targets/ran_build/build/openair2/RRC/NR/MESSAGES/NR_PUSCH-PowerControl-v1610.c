...
asn_TYPE_descriptor_t asn_DEF_NR_pathlossReferenceRSToAddModListSizeExt_v1610_2 = {
	...
	{ 0, &asn_PER_type_NR_pathlossReferenceRSToAddModListSizeExt_v1610_constr_2, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_pathlossReferenceRSToReleaseListSizeExt_v1610_4 = {
	...
	{ 0, &asn_PER_type_NR_pathlossReferenceRSToReleaseListSizeExt_v1610_constr_4, SEQUENCE_OF_constraint },
...
asn_TYPE_descriptor_t asn_DEF_NR_p0_PUSCH_SetList_r16_6 = {
	...
	{ 0, &asn_PER_type_NR_p0_PUSCH_SetList_r16_constr_6, SEQUENCE_OF_constraint },
...
static asn_TYPE_member_t asn_MBR_NR_olpc_ParameterSet_8[] = {
	{ ATF_POINTER, 2, offsetof(struct NR_PUSCH_PowerControl_v1610__olpc_ParameterSet, olpc_ParameterSetDCI_0_1_r16),
		...
		0,
		{ 0, &asn_PER_memb_NR_olpc_ParameterSetDCI_0_1_r16_constr_9,  memb_NR_olpc_ParameterSetDCI_0_1_r16_constraint_8 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 1, offsetof(struct NR_PUSCH_PowerControl_v1610__olpc_ParameterSet, olpc_ParameterSetDCI_0_2_r16),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_olpc_ParameterSetDCI_0_2_r16_constr_10,  memb_NR_olpc_ParameterSetDCI_0_2_r16_constraint_8 },
		0, 0, /* No default value */
...
asn_TYPE_member_t asn_MBR_NR_PUSCH_PowerControl_v1610_1[] = {
	{ ATF_POINTER, 4, offsetof(struct NR_PUSCH_PowerControl_v1610, pathlossReferenceRSToAddModListSizeExt_v1610),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		0,
		&asn_DEF_NR_pathlossReferenceRSToAddModListSizeExt_v1610_2,
		0,
		{ 0, &asn_PER_memb_NR_pathlossReferenceRSToAddModListSizeExt_v1610_constr_2,  memb_NR_pathlossReferenceRSToAddModListSizeExt_v1610_constraint_1 },
		0, 0, /* No default value */
		"pathlossReferenceRSToAddModListSizeExt-v1610"
		},
	{ ATF_POINTER, 3, offsetof(struct NR_PUSCH_PowerControl_v1610, pathlossReferenceRSToReleaseListSizeExt_v1610),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		0,
		&asn_DEF_NR_pathlossReferenceRSToReleaseListSizeExt_v1610_4,
		0,
		{ 0, &asn_PER_memb_NR_pathlossReferenceRSToReleaseListSizeExt_v1610_constr_4,  memb_NR_pathlossReferenceRSToReleaseListSizeExt_v1610_constraint_1 },
		0, 0, /* No default value */
		"pathlossReferenceRSToReleaseListSizeExt-v1610"
		},
	{ ATF_POINTER, 2, offsetof(struct NR_PUSCH_PowerControl_v1610, p0_PUSCH_SetList_r16),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		0,
		&asn_DEF_NR_p0_PUSCH_SetList_r16_6,
		0,
		{ 0, &asn_PER_memb_NR_p0_PUSCH_SetList_r16_constr_6,  memb_NR_p0_PUSCH_SetList_r16_constraint_1 },
		0, 0, /* No default value */
		"p0-PUSCH-SetList-r16"
		},
	{ ATF_POINTER, 1, offsetof(struct NR_PUSCH_PowerControl_v1610, olpc_ParameterSet),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		0,
...
static const int asn_MAP_NR_PUSCH_PowerControl_v1610_oms_1[] = { 0, 1, 2, 3 };
