 ...
 */
static int
memb_NR_maxNumberResourcesPerBand_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static int
memb_NR_totalNumberTxPortsPerBand_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	long value;
...
static asn_per_constraints_t asn_PER_memb_NR_maxNumberResourcesPerBand_constr_10 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 6,  6,  1,  64 }	/* (1..64) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_NR_totalNumberTxPortsPerBand_constr_11 CC_NOTUSED = {
...
asn_TYPE_member_t asn_MBR_NR_SupportedCSI_RS_Resource_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NR_SupportedCSI_RS_Resource, maxNumberTxPortsPerResource),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_SupportedCSI_RS_Resource, maxNumberResourcesPerBand),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_maxNumberResourcesPerBand_constr_10,  memb_NR_maxNumberResourcesPerBand_constraint_1 },
		0, 0, /* No default value */
		"maxNumberResourcesPerBand"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NR_SupportedCSI_RS_Resource, totalNumberTxPortsPerBand),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_NR_totalNumberTxPortsPerBand_constr_11,  memb_NR_totalNumberTxPortsPerBand_constraint_1 },
		0, 0, /* No default value */
		"totalNumberTxPortsPerBand"
		},
};
static const ber_tlv_tag_t asn_DEF_NR_SupportedCSI_RS_Resource_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_SupportedCSI_RS_Resource_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_NR_SupportedCSI_RS_Resource_specs_1 = {
	sizeof(struct NR_SupportedCSI_RS_Resource),
	offsetof(struct NR_SupportedCSI_RS_Resource, _asn_ctx),
	asn_MAP_NR_SupportedCSI_RS_Resource_tag2el_1,
	3,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_NR_SupportedCSI_RS_Resource = {
	"SupportedCSI-RS-Resource",
	"SupportedCSI-RS-Resource",
	&asn_OP_SEQUENCE,
	asn_DEF_NR_SupportedCSI_RS_Resource_tags_1,
	sizeof(asn_DEF_NR_SupportedCSI_RS_Resource_tags_1)
		/sizeof(asn_DEF_NR_SupportedCSI_RS_Resource_tags_1[0]), /* 1 */
	asn_DEF_NR_SupportedCSI_RS_Resource_tags_1,	/* Same as above */
	sizeof(asn_DEF_NR_SupportedCSI_RS_Resource_tags_1)
		/sizeof(asn_DEF_NR_SupportedCSI_RS_Resource_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_NR_SupportedCSI_RS_Resource_1,
	3,	/* Elements count */
	&asn_SPC_NR_SupportedCSI_RS_Resource_specs_1	/* Additional specs */
};
