...
static const ber_tlv_tag_t asn_DEF_NR_nonCriticalExtension_tags_11[] = {
	(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static asn_SEQUENCE_specifics_t asn_SPC_NR_nonCriticalExtension_specs_11 = {
	sizeof(struct NR_UEAssistanceInformation_v1610_IEs__nonCriticalExtension),
	offsetof(struct NR_UEAssistanceInformation_v1610_IEs__nonCriticalExtension, _asn_ctx),
	0,	/* No top level tags */
...
asn_TYPE_descriptor_t asn_DEF_NR_nonCriticalExtension_11 = {
	"nonCriticalExtension",
	"nonCriticalExtension",
	&asn_OP_SEQUENCE,
	asn_DEF_NR_nonCriticalExtension_tags_11,
	sizeof(asn_DEF_NR_nonCriticalExtension_tags_11)
		/sizeof(asn_DEF_NR_nonCriticalExtension_tags_11[0]) - 1, /* 1 */
	asn_DEF_NR_nonCriticalExtension_tags_11,	/* Same as above */
	sizeof(asn_DEF_NR_nonCriticalExtension_tags_11)
		/sizeof(asn_DEF_NR_nonCriticalExtension_tags_11[0]), /* 2 */
	{ 0, 0, SEQUENCE_constraint },
	0, 0,	/* No members */
	&asn_SPC_NR_nonCriticalExtension_specs_11	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_NR_UEAssistanceInformation_v1610_IEs_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct NR_UEAssistanceInformation_v1610_IEs, nonCriticalExtension),
		(ASN_TAG_CLASS_CONTEXT | (9 << 2)),
		0,
		&asn_DEF_NR_nonCriticalExtension_11,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"nonCriticalExtension"
