...
asn_TYPE_member_t asn_MBR_NR_VarMeasReport_1[] = {
	...
	{ ATF_POINTER, 2, offsetof(struct NR_VarMeasReport, cli_TriggeredList_r16),
	...
	{ ATF_POINTER, 1, offsetof(struct NR_VarMeasReport, tx_PoolMeasToAddModListNR_r16),
...
static const int asn_MAP_NR_VarMeasReport_oms_1[] = { 1, 3, 4 };
