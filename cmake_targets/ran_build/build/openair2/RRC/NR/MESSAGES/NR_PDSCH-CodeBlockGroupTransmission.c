...
asn_TYPE_descriptor_t asn_DEF_NR_maxCodeBlockGroupsPerTransportBlock_2 = {
	...
	{ 0, &asn_PER_type_NR_maxCodeBlockGroupsPerTransportBlock_constr_2, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_NR_maxCodeBlockGroupsPerTransportBlock_specs_2	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_NR_PDSCH_CodeBlockGroupTransmission_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NR_PDSCH_CodeBlockGroupTransmission, maxCodeBlockGroupsPerTransportBlock),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NR_PDSCH_CodeBlockGroupTransmission, codeBlockGroupFlushIndicator),
...
static const ber_tlv_tag_t asn_DEF_NR_PDSCH_CodeBlockGroupTransmission_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_NR_PDSCH_CodeBlockGroupTransmission_tag2el_1[] = {
...
asn_SEQUENCE_specifics_t asn_SPC_NR_PDSCH_CodeBlockGroupTransmission_specs_1 = {
	sizeof(struct NR_PDSCH_CodeBlockGroupTransmission),
	offsetof(struct NR_PDSCH_CodeBlockGroupTransmission, _asn_ctx),
	asn_MAP_NR_PDSCH_CodeBlockGroupTransmission_tag2el_1,
	2,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	2,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_NR_PDSCH_CodeBlockGroupTransmission = {
	"PDSCH-CodeBlockGroupTransmission",
	"PDSCH-CodeBlockGroupTransmission",
	&asn_OP_SEQUENCE,
	asn_DEF_NR_PDSCH_CodeBlockGroupTransmission_tags_1,
	sizeof(asn_DEF_NR_PDSCH_CodeBlockGroupTransmission_tags_1)
		/sizeof(asn_DEF_NR_PDSCH_CodeBlockGroupTransmission_tags_1[0]), /* 1 */
	asn_DEF_NR_PDSCH_CodeBlockGroupTransmission_tags_1,	/* Same as above */
	sizeof(asn_DEF_NR_PDSCH_CodeBlockGroupTransmission_tags_1)
		/sizeof(asn_DEF_NR_PDSCH_CodeBlockGroupTransmission_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_NR_PDSCH_CodeBlockGroupTransmission_1,
	2,	/* Elements count */
	&asn_SPC_NR_PDSCH_CodeBlockGroupTransmission_specs_1	/* Additional specs */
};
