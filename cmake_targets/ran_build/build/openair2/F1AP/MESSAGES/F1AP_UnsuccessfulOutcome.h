...
typedef enum F1AP_UnsuccessfulOutcome__value_PR {
	...
	F1AP_UnsuccessfulOutcome__value_PR_UEContextModificationRefuse,
	F1AP_UnsuccessfulOutcome__value_PR_F1RemovalFailure,
	F1AP_UnsuccessfulOutcome__value_PR_IABUPConfigurationUpdateFailure,
	F1AP_UnsuccessfulOutcome__value_PR_ResourceStatusFailure,
	F1AP_UnsuccessfulOutcome__value_PR_PositioningMeasurementFailure,
	F1AP_UnsuccessfulOutcome__value_PR_TRPInformationFailure,
	F1AP_UnsuccessfulOutcome__value_PR_PositioningInformationFailure,
	F1AP_UnsuccessfulOutcome__value_PR_PositioningActivationFailure,
	F1AP_UnsuccessfulOutcome__value_PR_E_CIDMeasurementInitiationFailure
...
typedef struct F1AP_UnsuccessfulOutcome {
	...
	struct F1AP_UnsuccessfulOutcome__value {
		...
		union F1AP_UnsuccessfulOutcome__F1AP_value_u {
			...
			F1AP_UEContextModificationRefuse_t	 UEContextModificationRefuse;
			F1AP_F1RemovalFailure_t	 F1RemovalFailure;
			F1AP_IABUPConfigurationUpdateFailure_t	 IABUPConfigurationUpdateFailure;
			F1AP_ResourceStatusFailure_t	 ResourceStatusFailure;
			F1AP_PositioningMeasurementFailure_t	 PositioningMeasurementFailure;
			F1AP_TRPInformationFailure_t	 TRPInformationFailure;
			F1AP_PositioningInformationFailure_t	 PositioningInformationFailure;
			F1AP_PositioningActivationFailure_t	 PositioningActivationFailure;
			F1AP_E_CIDMeasurementInitiationFailure_t	 E_CIDMeasurementInitiationFailure;
		} choice;
