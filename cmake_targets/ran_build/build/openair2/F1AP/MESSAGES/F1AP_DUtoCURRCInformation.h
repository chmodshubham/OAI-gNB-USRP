...
#ifndef	_F1AP_DUtoCURRCInformation_H_
#define	_F1AP_DUtoCURRCInformation_H_
...
typedef struct F1AP_DUtoCURRCInformation {
	F1AP_CellGroupConfig_t	 cellGroupConfig;
	F1AP_MeasGapConfig_t	*measGapConfig;	/* OPTIONAL */
...
/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_F1AP_DUtoCURRCInformation;
extern asn_SEQUENCE_specifics_t asn_SPC_F1AP_DUtoCURRCInformation_specs_1;
extern asn_TYPE_member_t asn_MBR_F1AP_DUtoCURRCInformation_1[4];

#ifdef __cplusplus
}
#endif

#endif	/* _F1AP_DUtoCURRCInformation_H_ */
