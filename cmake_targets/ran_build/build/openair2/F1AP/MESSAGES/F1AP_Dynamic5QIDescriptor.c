...
static asn_per_constraints_t asn_PER_type_F1AP_delayCritical_constr_6 CC_NOTUSED = {
...
static asn_per_constraints_t asn_PER_memb_F1AP_fiveQI_constr_5 CC_NOTUSED = {
	{ APC_CONSTRAINED | APC_EXTENSIBLE,  8,  8,  0,  255 }	/* (0..255,...) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
static const asn_INTEGER_enum_map_t asn_MAP_F1AP_delayCritical_value2enum_6[] = {
	{ 0,	14,	"delay-critical" },
	{ 1,	18,	"non-delay-critical" }
};
static const unsigned int asn_MAP_F1AP_delayCritical_enum2value_6[] = {
	0,	/* delay-critical(0) */
	1	/* non-delay-critical(1) */
};
static const asn_INTEGER_specifics_t asn_SPC_F1AP_delayCritical_specs_6 = {
	asn_MAP_F1AP_delayCritical_value2enum_6,	/* "tag" => N; sorted by tag */
	asn_MAP_F1AP_delayCritical_enum2value_6,	/* N => "tag"; sorted by N */
...
static const ber_tlv_tag_t asn_DEF_F1AP_delayCritical_tags_6[] = {
	(ASN_TAG_CLASS_CONTEXT | (4 << 2)),
	(ASN_TAG_CLASS_UNIVERSAL | (10 << 2))
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_F1AP_delayCritical_6 = {
	"delayCritical",
	"delayCritical",
	&asn_OP_NativeEnumerated,
	asn_DEF_F1AP_delayCritical_tags_6,
	sizeof(asn_DEF_F1AP_delayCritical_tags_6)
		/sizeof(asn_DEF_F1AP_delayCritical_tags_6[0]) - 1, /* 1 */
	asn_DEF_F1AP_delayCritical_tags_6,	/* Same as above */
	sizeof(asn_DEF_F1AP_delayCritical_tags_6)
		/sizeof(asn_DEF_F1AP_delayCritical_tags_6[0]), /* 2 */
	{ 0, &asn_PER_type_F1AP_delayCritical_constr_6, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
	&asn_SPC_F1AP_delayCritical_specs_6	/* Additional specs */
};
...
asn_TYPE_member_t asn_MBR_F1AP_Dynamic5QIDescriptor_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct F1AP_Dynamic5QIDescriptor, fiveQI),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_fiveQI_constr_5,  memb_F1AP_fiveQI_constraint_1 },
		0, 0, /* No default value */
		"fiveQI"
		},
	...
	{ ATF_POINTER, 1, offsetof(struct F1AP_Dynamic5QIDescriptor, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_F1AP_ProtocolExtensionContainer_10696P87,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_F1AP_Dynamic5QIDescriptor_oms_1[] = { 3, 4, 5, 6, 7 };
