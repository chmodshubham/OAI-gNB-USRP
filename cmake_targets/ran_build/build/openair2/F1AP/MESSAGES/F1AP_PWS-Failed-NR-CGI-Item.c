...
asn_TYPE_member_t asn_MBR_F1AP_PWS_Failed_NR_CGI_Item_1[] = {
	...
	{ ATF_POINTER, 1, offsetof(struct F1AP_PWS_Failed_NR_CGI_Item, iE_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_F1AP_ProtocolExtensionContainer_10696P201,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
asn_SEQUENCE_specifics_t asn_SPC_F1AP_PWS_Failed_NR_CGI_Item_specs_1 = {
