...
extern asn_SEQUENCE_specifics_t asn_SPC_F1AP_GNB_CU_TNL_Association_To_Update_Item_specs_1;
extern asn_TYPE_member_t asn_MBR_F1AP_GNB_CU_TNL_Association_To_Update_Item_1[3];
