...
asn_TYPE_member_t asn_MBR_F1AP_ResourceTypeSemi_persistent_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_ResourceTypeSemi_persistent, periodicity),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
	...
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_ResourceTypeSemi_persistent, offset),
		(ASN_TAG_CLASS_CONTEXT | (1 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_offset_constr_21,  memb_F1AP_offset_constraint_1 },
		0, 0, /* No default value */
		"offset"
		},
	{ ATF_POINTER, 1, offsetof(struct F1AP_ResourceTypeSemi_persistent, iE_Extensions),
		(ASN_TAG_CLASS_CONTEXT | (2 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_F1AP_ProtocolExtensionContainer_10696P217,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"iE-Extensions"
...
static const int asn_MAP_F1AP_ResourceTypeSemi_persistent_oms_1[] = { 2 };
static const ber_tlv_tag_t asn_DEF_F1AP_ResourceTypeSemi_persistent_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_F1AP_ResourceTypeSemi_persistent_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* periodicity */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 }, /* offset */
    { (ASN_TAG_CLASS_CONTEXT | (2 << 2)), 2, 0, 0 } /* iE-Extensions */
};
asn_SEQUENCE_specifics_t asn_SPC_F1AP_ResourceTypeSemi_persistent_specs_1 = {
	sizeof(struct F1AP_ResourceTypeSemi_persistent),
	offsetof(struct F1AP_ResourceTypeSemi_persistent, _asn_ctx),
	asn_MAP_F1AP_ResourceTypeSemi_persistent_tag2el_1,
	3,	/* Count of tags in the map */
	asn_MAP_F1AP_ResourceTypeSemi_persistent_oms_1,	/* Optional members */
	1, 0,	/* Root/Additions */
	-1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_F1AP_ResourceTypeSemi_persistent = {
	"ResourceTypeSemi-persistent",
	"ResourceTypeSemi-persistent",
	&asn_OP_SEQUENCE,
	asn_DEF_F1AP_ResourceTypeSemi_persistent_tags_1,
	sizeof(asn_DEF_F1AP_ResourceTypeSemi_persistent_tags_1)
		/sizeof(asn_DEF_F1AP_ResourceTypeSemi_persistent_tags_1[0]), /* 1 */
	asn_DEF_F1AP_ResourceTypeSemi_persistent_tags_1,	/* Same as above */
	sizeof(asn_DEF_F1AP_ResourceTypeSemi_persistent_tags_1)
		/sizeof(asn_DEF_F1AP_ResourceTypeSemi_persistent_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_F1AP_ResourceTypeSemi_persistent_1,
	3,	/* Elements count */
	&asn_SPC_F1AP_ResourceTypeSemi_persistent_specs_1	/* Additional specs */
};
