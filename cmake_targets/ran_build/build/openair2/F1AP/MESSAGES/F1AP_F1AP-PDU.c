...
static asn_TYPE_member_t asn_MBR_F1AP_F1AP_PDU_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct F1AP_F1AP_PDU, choice.choice_extension),
		(ASN_TAG_CLASS_CONTEXT | (3 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_F1AP_ProtocolIE_SingleContainer_10662P0,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
...
asn_TYPE_descriptor_t asn_DEF_F1AP_F1AP_PDU = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_F1AP_F1AP_PDU_constr_1, CHOICE_constraint },
