...
asn_TYPE_descriptor_t asn_DEF_F1AP_nrofSRS_Ports_3 = {
	...
	{ 0, &asn_PER_type_F1AP_nrofSRS_Ports_constr_3, NativeEnumerated_constraint },
...
asn_TYPE_descriptor_t asn_DEF_F1AP_nrofSymbols_9 = {
	...
	{ 0, &asn_PER_type_F1AP_nrofSymbols_constr_9, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_F1AP_repetitionFactor_13 = {
	...
	{ 0, &asn_PER_type_F1AP_repetitionFactor_constr_13, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_descriptor_t asn_DEF_F1AP_groupOrSequenceHopping_22 = {
	...
	{ 0, &asn_PER_type_F1AP_groupOrSequenceHopping_constr_22, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_F1AP_SRSResource_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_SRSResource, startPosition),
		...
		0,
		{ 0, &asn_PER_memb_F1AP_startPosition_constr_8,  memb_F1AP_startPosition_constraint_1 },
		0, 0, /* No default value */
		"startPosition"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_SRSResource, freqDomainPosition),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_freqDomainPosition_constr_17,  memb_F1AP_freqDomainPosition_constraint_1 },
		0, 0, /* No default value */
		"freqDomainPosition"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_SRSResource, freqDomainShift),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_freqDomainShift_constr_18,  memb_F1AP_freqDomainShift_constraint_1 },
		0, 0, /* No default value */
		"freqDomainShift"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_SRSResource, c_SRS),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_c_SRS_constr_19,  memb_F1AP_c_SRS_constraint_1 },
		0, 0, /* No default value */
		"c-SRS"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_SRSResource, b_SRS),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_b_SRS_constr_20,  memb_F1AP_b_SRS_constraint_1 },
		0, 0, /* No default value */
		"b-SRS"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_SRSResource, b_hop),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_b_hop_constr_21,  memb_F1AP_b_hop_constraint_1 },
		0, 0, /* No default value */
		"b-hop"
		},
	...
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_SRSResource, slotOffset),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_slotOffset_constr_27,  memb_F1AP_slotOffset_constraint_1 },
		0, 0, /* No default value */
		"slotOffset"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_SRSResource, sequenceId),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_sequenceId_constr_28,  memb_F1AP_sequenceId_constraint_1 },
		0, 0, /* No default value */
		"sequenceId"
		},
