...
#ifndef	_F1AP_EUTRACells_List_item_H_
#define	_F1AP_EUTRACells_List_item_H_
...
/* F1AP_EUTRACells-List-item */
typedef struct F1AP_EUTRACells_List_item {
	F1AP_EUTRA_Cell_ID_t	 eUTRA_Cell_ID;
...
} F1AP_EUTRACells_List_item_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_F1AP_EUTRACells_List_item;
extern asn_SEQUENCE_specifics_t asn_SPC_F1AP_EUTRACells_List_item_specs_1;
extern asn_TYPE_member_t asn_MBR_F1AP_EUTRACells_List_item_1[3];

#ifdef __cplusplus
}
#endif

#endif	/* _F1AP_EUTRACells_List_item_H_ */
