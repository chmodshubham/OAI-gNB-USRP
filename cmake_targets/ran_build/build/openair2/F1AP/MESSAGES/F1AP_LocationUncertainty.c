...
asn_TYPE_member_t asn_MBR_F1AP_LocationUncertainty_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_LocationUncertainty, horizontalUncertainty),
		...
		0,
		{ 0, &asn_PER_memb_F1AP_horizontalUncertainty_constr_2,  memb_F1AP_horizontalUncertainty_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_LocationUncertainty, horizontalConfidence),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_horizontalConfidence_constr_3,  memb_F1AP_horizontalConfidence_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_LocationUncertainty, verticalUncertainty),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_verticalUncertainty_constr_4,  memb_F1AP_verticalUncertainty_constraint_1 },
		0, 0, /* No default value */
		"verticalUncertainty"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct F1AP_LocationUncertainty, verticalConfidence),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_F1AP_verticalConfidence_constr_5,  memb_F1AP_verticalConfidence_constraint_1 },
		0, 0, /* No default value */
		"verticalConfidence"
		},
