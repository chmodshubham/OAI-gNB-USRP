...
asn_per_constraints_t asn_PER_type_F1AP_PagingIdentity_constr_1 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 2,  2,  0,  2 }	/* (0..2) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_F1AP_PagingIdentity_1[] = {
	...
	{ ATF_POINTER, 0, offsetof(struct F1AP_PagingIdentity, choice.choice_extension),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_F1AP_ProtocolIE_SingleContainer_10662P119,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-extension"
...
asn_CHOICE_specifics_t asn_SPC_F1AP_PagingIdentity_specs_1 = {
...
asn_TYPE_descriptor_t asn_DEF_F1AP_PagingIdentity = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_F1AP_PagingIdentity_constr_1, CHOICE_constraint },
