...
#ifndef	_F1AP_SSBToReportItem_H_
#define	_F1AP_SSBToReportItem_H_
...
/* F1AP_SSBToReportItem */
typedef struct F1AP_SSBToReportItem {
	long	 sSBIndex;
	struct F1AP_ProtocolExtensionContainer	*iE_Extensions;	/* OPTIONAL */
	
	/* Context for parsing across buffer boundaries */
	asn_struct_ctx_t _asn_ctx;
} F1AP_SSBToReportItem_t;

/* Implementation */
extern asn_TYPE_descriptor_t asn_DEF_F1AP_SSBToReportItem;
extern asn_SEQUENCE_specifics_t asn_SPC_F1AP_SSBToReportItem_specs_1;
extern asn_TYPE_member_t asn_MBR_F1AP_SSBToReportItem_1[2];

#ifdef __cplusplus
}
#endif

#endif	/* _F1AP_SSBToReportItem_H_ */
