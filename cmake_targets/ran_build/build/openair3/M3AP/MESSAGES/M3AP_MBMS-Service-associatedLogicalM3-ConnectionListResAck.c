...
asn_TYPE_member_t asn_MBR_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListResAck_1[] = {
	{ ATF_POINTER, 0, 0,
		...
		0,
		&asn_DEF_M3AP_ProtocolIE_Single_Container_1006P1,
		0,
		{ 0, 0, 0 },
...
asn_TYPE_descriptor_t asn_DEF_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListResAck = {
	...
	sizeof(asn_DEF_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListResAck_tags_1)
		/sizeof(asn_DEF_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListResAck_tags_1[0]), /* 1 */
	{ 0, &asn_PER_type_M3AP_MBMS_Service_associatedLogicalM3_ConnectionListResAck_constr_1, SEQUENCE_OF_constraint },
