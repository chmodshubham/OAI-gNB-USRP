...
asn_TYPE_member_t asn_MBR_NGAP_NgENB_ID_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_NgENB_ID, choice.macroNgENB_ID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_NGAP_macroNgENB_ID_constr_2,  memb_NGAP_macroNgENB_ID_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_NgENB_ID, choice.shortMacroNgENB_ID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_NGAP_shortMacroNgENB_ID_constr_3,  memb_NGAP_shortMacroNgENB_ID_constraint_1 },
		0, 0, /* No default value */
		"shortMacroNgENB-ID"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct NGAP_NgENB_ID, choice.longMacroNgENB_ID),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_NGAP_longMacroNgENB_ID_constr_4,  memb_NGAP_longMacroNgENB_ID_constraint_1 },
		0, 0, /* No default value */
		"longMacroNgENB-ID"
		},
	{ ATF_POINTER, 0, offsetof(struct NGAP_NgENB_ID, choice.choice_Extensions),
		...
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NGAP_ProtocolIE_SingleContainer_6813P12,
		0,
		{ 0, 0, 0 },
		0, 0, /* No default value */
		"choice-Extensions"
...
asn_TYPE_descriptor_t asn_DEF_NGAP_NgENB_ID = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_NGAP_NgENB_ID_constr_1, CHOICE_constraint },
