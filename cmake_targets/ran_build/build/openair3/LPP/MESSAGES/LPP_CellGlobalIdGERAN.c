...
asn_TYPE_member_t asn_MBR_LPP_CellGlobalIdGERAN_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_CellGlobalIdGERAN, locationAreaCode),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_LPP_locationAreaCode_constr_7,  memb_LPP_locationAreaCode_constraint_1 },
		0, 0, /* No default value */
		"locationAreaCode"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_CellGlobalIdGERAN, cellIdentity),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_LPP_cellIdentity_constr_8,  memb_LPP_cellIdentity_constraint_1 },
		0, 0, /* No default value */
		"cellIdentity"
		},
};
