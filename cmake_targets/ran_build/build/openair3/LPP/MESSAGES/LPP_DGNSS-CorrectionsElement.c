...
asn_TYPE_member_t asn_MBR_LPP_DGNSS_CorrectionsElement_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_DGNSS_CorrectionsElement, udre),
		...
		0,
		{ 0, &asn_PER_memb_LPP_udre_constr_4,  memb_LPP_udre_constraint_1 },
		0, 0, /* No default value */
		"udre"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_DGNSS_CorrectionsElement, pseudoRangeCor),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_pseudoRangeCor_constr_5,  memb_LPP_pseudoRangeCor_constraint_1 },
		0, 0, /* No default value */
		"pseudoRangeCor"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_DGNSS_CorrectionsElement, rangeRateCor),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_rangeRateCor_constr_6,  memb_LPP_rangeRateCor_constraint_1 },
		0, 0, /* No default value */
		"rangeRateCor"
		},
	{ ATF_POINTER, 2, offsetof(struct LPP_DGNSS_CorrectionsElement, udreGrowthRate),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_udreGrowthRate_constr_7,  memb_LPP_udreGrowthRate_constraint_1 },
		0, 0, /* No default value */
		"udreGrowthRate"
		},
	{ ATF_POINTER, 1, offsetof(struct LPP_DGNSS_CorrectionsElement, udreValidityTime),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_udreValidityTime_constr_8,  memb_LPP_udreValidityTime_constraint_1 },
		0, 0, /* No default value */
		"udreValidityTime"
		},
};
