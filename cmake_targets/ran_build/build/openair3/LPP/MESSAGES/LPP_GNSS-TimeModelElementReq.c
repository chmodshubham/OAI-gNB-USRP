...
static int
memb_LPP_gnss_TO_IDsReq_constraint_1(const asn_TYPE_descriptor_t *td, const void *sptr,
...
static asn_per_constraints_t asn_PER_memb_LPP_gnss_TO_IDsReq_constr_2 CC_NOTUSED = {
	{ APC_CONSTRAINED,	 4,  4,  1,  15 }	/* (1..15) */,
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	0, 0	/* No PER value map */
};
asn_TYPE_member_t asn_MBR_LPP_GNSS_TimeModelElementReq_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_GNSS_TimeModelElementReq, gnss_TO_IDsReq),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_gnss_TO_IDsReq_constr_2,  memb_LPP_gnss_TO_IDsReq_constraint_1 },
...
static const ber_tlv_tag_t asn_DEF_LPP_GNSS_TimeModelElementReq_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_LPP_GNSS_TimeModelElementReq_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* gnss-TO-IDsReq */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* deltaTreq */
};
asn_SEQUENCE_specifics_t asn_SPC_LPP_GNSS_TimeModelElementReq_specs_1 = {
