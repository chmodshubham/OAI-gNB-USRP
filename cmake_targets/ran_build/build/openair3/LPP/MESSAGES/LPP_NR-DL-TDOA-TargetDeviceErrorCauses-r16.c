...
asn_TYPE_member_t asn_MBR_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16, cause_r16),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
...
static const ber_tlv_tag_t asn_DEF_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 } /* cause-r16 */
};
asn_SEQUENCE_specifics_t asn_SPC_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_specs_1 = {
	sizeof(struct LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16),
	offsetof(struct LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16, _asn_ctx),
	asn_MAP_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_tag2el_1,
	1,	/* Count of tags in the map */
	0, 0, 0,	/* Optional elements (not needed) */
	1,	/* First extension addition */
};
asn_TYPE_descriptor_t asn_DEF_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16 = {
	"NR-DL-TDOA-TargetDeviceErrorCauses-r16",
	"NR-DL-TDOA-TargetDeviceErrorCauses-r16",
	&asn_OP_SEQUENCE,
	asn_DEF_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_tags_1,
	sizeof(asn_DEF_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_tags_1)
		/sizeof(asn_DEF_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_tags_1[0]), /* 1 */
	asn_DEF_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_tags_1,	/* Same as above */
	sizeof(asn_DEF_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_tags_1)
		/sizeof(asn_DEF_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_tags_1[0]), /* 1 */
	{ 0, 0, SEQUENCE_constraint },
	asn_MBR_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_1,
	1,	/* Elements count */
	&asn_SPC_LPP_NR_DL_TDOA_TargetDeviceErrorCauses_r16_specs_1	/* Additional specs */
};
