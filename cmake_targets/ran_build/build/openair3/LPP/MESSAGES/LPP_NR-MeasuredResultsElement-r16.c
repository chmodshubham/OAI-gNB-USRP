...
asn_TYPE_descriptor_t asn_DEF_LPP_nr_ARFCN_r16_3 = {
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_LPP_nr_ARFCN_r16_constr_3, CHOICE_constraint },
...
asn_TYPE_member_t asn_MBR_LPP_NR_MeasuredResultsElement_r16_1[] = {
	...
	{ ATF_POINTER, 5, offsetof(struct LPP_NR_MeasuredResultsElement_r16, systemFrameNumber_r16),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_LPP_systemFrameNumber_r16_constr_7,  memb_LPP_systemFrameNumber_r16_constraint_1 },
		0, 0, /* No default value */
