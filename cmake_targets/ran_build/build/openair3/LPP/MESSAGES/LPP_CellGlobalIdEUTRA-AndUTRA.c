...
static int
memb_LPP_eutra_constraint_7(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
...
static int
memb_LPP_utra_constraint_7(const asn_TYPE_descriptor_t *td, const void *sptr,
			asn_app_constraint_failed_f *ctfailcb, void *app_key) {
	const BIT_STRING_t *st = (const BIT_STRING_t *)sptr;
	size_t size;
...
static asn_per_constraints_t asn_PER_memb_LPP_eutra_constr_8 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  28,  28 }	/* (SIZE(28..28)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_memb_LPP_utra_constr_9 CC_NOTUSED = {
	{ APC_UNCONSTRAINED,	-1, -1,  0,  0 },
	{ APC_CONSTRAINED,	 0,  0,  32,  32 }	/* (SIZE(32..32)) */,
	0, 0	/* No PER value map */
};
static asn_per_constraints_t asn_PER_type_LPP_cellIdentity_constr_7 CC_NOTUSED = {
...
asn_TYPE_descriptor_t asn_DEF_LPP_mcc_3 = {
	...
	{ 0, &asn_PER_type_LPP_mcc_constr_3, SEQUENCE_OF_constraint },
	asn_MBR_LPP_mcc_3,
	1,	/* Single element */
...
asn_TYPE_descriptor_t asn_DEF_LPP_mnc_5 = {
	...
	{ 0, &asn_PER_type_LPP_mnc_constr_5, SEQUENCE_OF_constraint },
	asn_MBR_LPP_mnc_5,
	1,	/* Single element */
...
static asn_TYPE_member_t asn_MBR_LPP_plmn_Identity_2[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_CellGlobalIdEUTRA_AndUTRA__plmn_Identity, mcc),
		...
		&asn_DEF_LPP_mcc_3,
		0,
		{ 0, &asn_PER_memb_LPP_mcc_constr_3,  memb_LPP_mcc_constraint_2 },
		0, 0, /* No default value */
		"mcc"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_CellGlobalIdEUTRA_AndUTRA__plmn_Identity, mnc),
		...
		&asn_DEF_LPP_mnc_5,
		0,
		{ 0, &asn_PER_memb_LPP_mnc_constr_5,  memb_LPP_mnc_constraint_2 },
		0, 0, /* No default value */
		"mnc"
		},
};
...
static asn_TYPE_member_t asn_MBR_LPP_cellIdentity_7[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_CellGlobalIdEUTRA_AndUTRA__cellIdentity, choice.eutra),
		(ASN_TAG_CLASS_CONTEXT | (0 << 2)),
		-1,	/* IMPLICIT tag at current level */
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_LPP_eutra_constr_8,  memb_LPP_eutra_constraint_7 },
		0, 0, /* No default value */
		"eutra"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_CellGlobalIdEUTRA_AndUTRA__cellIdentity, choice.utra),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_LPP_utra_constr_9,  memb_LPP_utra_constraint_7 },
		0, 0, /* No default value */
		"utra"
		},
};
static const asn_TYPE_tag2member_t asn_MAP_LPP_cellIdentity_tag2el_7[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* eutra */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* utra */
};
static asn_CHOICE_specifics_t asn_SPC_LPP_cellIdentity_specs_7 = {
	...
	asn_MAP_LPP_cellIdentity_tag2el_7,
	2,	/* Count of tags in the map */
	0, 0,
	-1	/* Extensions start */
};
static /* Use -fall-defs-global to expose */
asn_TYPE_descriptor_t asn_DEF_LPP_cellIdentity_7 = {
	"cellIdentity",
	"cellIdentity",
	&asn_OP_CHOICE,
	...
	0,	/* No tags (pointer) */
	0,	/* No tags (count) */
	{ 0, &asn_PER_type_LPP_cellIdentity_constr_7, CHOICE_constraint },
	asn_MBR_LPP_cellIdentity_7,
	2,	/* Elements count */
	&asn_SPC_LPP_cellIdentity_specs_7	/* Additional specs */
};

asn_TYPE_member_t asn_MBR_LPP_CellGlobalIdEUTRA_AndUTRA_1[] = {
...
static const ber_tlv_tag_t asn_DEF_LPP_CellGlobalIdEUTRA_AndUTRA_tags_1[] = {
	(ASN_TAG_CLASS_UNIVERSAL | (16 << 2))
};
static const asn_TYPE_tag2member_t asn_MAP_LPP_CellGlobalIdEUTRA_AndUTRA_tag2el_1[] = {
    { (ASN_TAG_CLASS_CONTEXT | (0 << 2)), 0, 0, 0 }, /* plmn-Identity */
    { (ASN_TAG_CLASS_CONTEXT | (1 << 2)), 1, 0, 0 } /* cellIdentity */
};
asn_SEQUENCE_specifics_t asn_SPC_LPP_CellGlobalIdEUTRA_AndUTRA_specs_1 = {
