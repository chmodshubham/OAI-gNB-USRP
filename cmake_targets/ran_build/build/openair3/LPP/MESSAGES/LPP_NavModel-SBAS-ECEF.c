...
asn_TYPE_member_t asn_MBR_LPP_NavModel_SBAS_ECEF_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NavModel_SBAS_ECEF, sbasAccuracy),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_LPP_sbasAccuracy_constr_3,  memb_LPP_sbasAccuracy_constraint_1 },
		0, 0, /* No default value */
		"sbasAccuracy"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NavModel_SBAS_ECEF, sbasXg),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_sbasXg_constr_4,  memb_LPP_sbasXg_constraint_1 },
		0, 0, /* No default value */
		"sbasXg"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NavModel_SBAS_ECEF, sbasYg),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_sbasYg_constr_5,  memb_LPP_sbasYg_constraint_1 },
		0, 0, /* No default value */
		"sbasYg"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NavModel_SBAS_ECEF, sbasZg),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_sbasZg_constr_6,  memb_LPP_sbasZg_constraint_1 },
		0, 0, /* No default value */
		"sbasZg"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NavModel_SBAS_ECEF, sbasXgDot),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_sbasXgDot_constr_7,  memb_LPP_sbasXgDot_constraint_1 },
		0, 0, /* No default value */
		"sbasXgDot"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NavModel_SBAS_ECEF, sbasYgDot),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_sbasYgDot_constr_8,  memb_LPP_sbasYgDot_constraint_1 },
		0, 0, /* No default value */
		"sbasYgDot"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NavModel_SBAS_ECEF, sbasZgDot),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_sbasZgDot_constr_9,  memb_LPP_sbasZgDot_constraint_1 },
		0, 0, /* No default value */
		"sbasZgDot"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NavModel_SBAS_ECEF, sbasXgDotDot),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_sbasXgDotDot_constr_10,  memb_LPP_sbasXgDotDot_constraint_1 },
		0, 0, /* No default value */
		"sbasXgDotDot"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NavModel_SBAS_ECEF, sbagYgDotDot),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_sbagYgDotDot_constr_11,  memb_LPP_sbagYgDotDot_constraint_1 },
		0, 0, /* No default value */
		"sbagYgDotDot"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NavModel_SBAS_ECEF, sbasZgDotDot),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_sbasZgDotDot_constr_12,  memb_LPP_sbasZgDotDot_constraint_1 },
		0, 0, /* No default value */
		"sbasZgDotDot"
		},
};
