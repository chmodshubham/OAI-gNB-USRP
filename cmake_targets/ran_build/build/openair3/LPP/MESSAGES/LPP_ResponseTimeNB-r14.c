...
asn_TYPE_descriptor_t asn_DEF_LPP_unitNB_r15_6 = {
	...
	{ 0, &asn_PER_type_LPP_unitNB_r15_constr_6, NativeEnumerated_constraint },
...
asn_TYPE_member_t asn_MBR_LPP_ResponseTimeNB_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_ResponseTimeNB_r14, timeNB_r14),
		...
		0,
		{ 0, &asn_PER_memb_LPP_timeNB_r14_constr_2,  memb_LPP_timeNB_r14_constraint_1 },
		0, 0, /* No default value */
		"timeNB-r14"
		},
	{ ATF_POINTER, 2, offsetof(struct LPP_ResponseTimeNB_r14, responseTimeEarlyFixNB_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_responseTimeEarlyFixNB_r14_constr_3,  memb_LPP_responseTimeEarlyFixNB_r14_constraint_1 },
		0, 0, /* No default value */
