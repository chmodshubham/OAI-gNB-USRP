...
asn_TYPE_member_t asn_MBR_LPP_NeighbourMeasurementElement_NB_r14_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NeighbourMeasurementElement_NB_r14, physCellIdNeighbour_r14),
		...
		0,
		{ 0, &asn_PER_memb_LPP_physCellIdNeighbour_r14_constr_2,  memb_LPP_physCellIdNeighbour_r14_constraint_1 },
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_NeighbourMeasurementElement_NB_r14, rstd_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_rstd_r14_constr_5,  memb_LPP_rstd_r14_constraint_1 },
		0, 0, /* No default value */
		"rstd-r14"
		},
	...
	{ ATF_POINTER, 6, offsetof(struct LPP_NeighbourMeasurementElement_NB_r14, tpIdNeighbour_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_tpIdNeighbour_r14_constr_7,  memb_LPP_tpIdNeighbour_r14_constraint_1 },
		0, 0, /* No default value */
		"tpIdNeighbour-r14"
		},
	{ ATF_POINTER, 5, offsetof(struct LPP_NeighbourMeasurementElement_NB_r14, prsIdNeighbour_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_prsIdNeighbour_r14_constr_8,  memb_LPP_prsIdNeighbour_r14_constraint_1 },
		0, 0, /* No default value */
		"prsIdNeighbour-r14"
		},
	{ ATF_POINTER, 4, offsetof(struct LPP_NeighbourMeasurementElement_NB_r14, delta_rstd_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_delta_rstd_r14_constr_9,  memb_LPP_delta_rstd_r14_constraint_1 },
		0, 0, /* No default value */
		"delta-rstd-r14"
		},
	...
	{ ATF_POINTER, 2, offsetof(struct LPP_NeighbourMeasurementElement_NB_r14, nprsIdNeighbour_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_nprsIdNeighbour_r14_constr_11,  memb_LPP_nprsIdNeighbour_r14_constraint_1 },
		0, 0, /* No default value */
		"nprsIdNeighbour-r14"
		},
