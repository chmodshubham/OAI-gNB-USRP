...
asn_TYPE_member_t asn_MBR_LPP_GNSS_DataBitAssistanceReq_1[] = {
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_GNSS_DataBitAssistanceReq, gnss_TOD_Req),
		...
		0,
		{ 0, &asn_PER_memb_LPP_gnss_TOD_Req_constr_2,  memb_LPP_gnss_TOD_Req_constraint_1 },
	...
	{ ATF_POINTER, 1, offsetof(struct LPP_GNSS_DataBitAssistanceReq, gnss_TOD_FracReq),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_gnss_TOD_FracReq_constr_3,  memb_LPP_gnss_TOD_FracReq_constraint_1 },
		0, 0, /* No default value */
		"gnss-TOD-FracReq"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_GNSS_DataBitAssistanceReq, dataBitInterval),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_dataBitInterval_constr_4,  memb_LPP_dataBitInterval_constraint_1 },
		0, 0, /* No default value */
		"dataBitInterval"
		},
