...
asn_TYPE_member_t asn_MBR_LPP_AlmanacKeplerianSet_1[] = {
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_AlmanacKeplerianSet, kepAlmanacE),
		...
		0,
		{ 0, &asn_PER_memb_LPP_kepAlmanacE_constr_3,  memb_LPP_kepAlmanacE_constraint_1 },
		0, 0, /* No default value */
		"kepAlmanacE"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_AlmanacKeplerianSet, kepAlmanacDeltaI),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_kepAlmanacDeltaI_constr_4,  memb_LPP_kepAlmanacDeltaI_constraint_1 },
		0, 0, /* No default value */
		"kepAlmanacDeltaI"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_AlmanacKeplerianSet, kepAlmanacOmegaDot),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_kepAlmanacOmegaDot_constr_5,  memb_LPP_kepAlmanacOmegaDot_constraint_1 },
		0, 0, /* No default value */
		"kepAlmanacOmegaDot"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_AlmanacKeplerianSet, kepSV_StatusINAV),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_LPP_kepSV_StatusINAV_constr_6,  memb_LPP_kepSV_StatusINAV_constraint_1 },
		0, 0, /* No default value */
		"kepSV-StatusINAV"
		},
	{ ATF_POINTER, 1, offsetof(struct LPP_AlmanacKeplerianSet, kepSV_StatusFNAV),
		...
		&asn_DEF_BIT_STRING,
		0,
		{ 0, &asn_PER_memb_LPP_kepSV_StatusFNAV_constr_7,  memb_LPP_kepSV_StatusFNAV_constraint_1 },
		0, 0, /* No default value */
		"kepSV-StatusFNAV"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_AlmanacKeplerianSet, kepAlmanacAPowerHalf),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_kepAlmanacAPowerHalf_constr_8,  memb_LPP_kepAlmanacAPowerHalf_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_AlmanacKeplerianSet, kepAlmanacOmega0),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_kepAlmanacOmega0_constr_9,  memb_LPP_kepAlmanacOmega0_constraint_1 },
		0, 0, /* No default value */
		"kepAlmanacOmega0"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_AlmanacKeplerianSet, kepAlmanacW),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_kepAlmanacW_constr_10,  memb_LPP_kepAlmanacW_constraint_1 },
		0, 0, /* No default value */
		"kepAlmanacW"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_AlmanacKeplerianSet, kepAlmanacM0),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_kepAlmanacM0_constr_11,  memb_LPP_kepAlmanacM0_constraint_1 },
		0, 0, /* No default value */
		"kepAlmanacM0"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_AlmanacKeplerianSet, kepAlmanacAF0),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_kepAlmanacAF0_constr_12,  memb_LPP_kepAlmanacAF0_constraint_1 },
		0, 0, /* No default value */
		"kepAlmanacAF0"
		},
	{ ATF_NOFLAGS, 0, offsetof(struct LPP_AlmanacKeplerianSet, kepAlmanacAF1),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_kepAlmanacAF1_constr_13,  memb_LPP_kepAlmanacAF1_constraint_1 },
		0, 0, /* No default value */
		"kepAlmanacAF1"
		},
};
