...
asn_TYPE_descriptor_t asn_DEF_LPP_otdoa_SIB1_NB_repetitions_r14_10 = {
	...
	{ 0, &asn_PER_type_LPP_otdoa_SIB1_NB_repetitions_r14_constr_10, NativeEnumerated_constraint },
	0, 0,	/* Defined elsewhere */
...
asn_TYPE_member_t asn_MBR_LPP_OTDOA_NeighbourCellInfoNB_r14_1[] = {
	...
	{ ATF_POINTER, 8, offsetof(struct LPP_OTDOA_NeighbourCellInfoNB_r14, nprs_slotNumberOffset_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_nprs_slotNumberOffset_r14_constr_15,  memb_LPP_nprs_slotNumberOffset_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 7, offsetof(struct LPP_OTDOA_NeighbourCellInfoNB_r14, nprs_SFN_Offset_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_nprs_SFN_Offset_r14_constr_16,  memb_LPP_nprs_SFN_Offset_r14_constraint_1 },
		0, 0, /* No default value */
		"nprs-SFN-Offset-r14"
		},
	{ ATF_POINTER, 6, offsetof(struct LPP_OTDOA_NeighbourCellInfoNB_r14, nprs_SubframeOffset_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_nprs_SubframeOffset_r14_constr_17,  memb_LPP_nprs_SubframeOffset_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 5, offsetof(struct LPP_OTDOA_NeighbourCellInfoNB_r14, expectedRSTD_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_expectedRSTD_r14_constr_18,  memb_LPP_expectedRSTD_r14_constraint_1 },
		0, 0, /* No default value */
		"expectedRSTD-r14"
		},
	{ ATF_POINTER, 4, offsetof(struct LPP_OTDOA_NeighbourCellInfoNB_r14, expectedRSTD_Uncertainty_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_expectedRSTD_Uncertainty_r14_constr_19,  memb_LPP_expectedRSTD_Uncertainty_r14_constraint_1 },
		0, 0, /* No default value */
	...
	{ ATF_POINTER, 3, offsetof(struct LPP_OTDOA_NeighbourCellInfoNB_r14, prsNeighbourCellIndex_r14),
		...
		&asn_DEF_NativeInteger,
		0,
		{ 0, &asn_PER_memb_LPP_prsNeighbourCellIndex_r14_constr_20,  memb_LPP_prsNeighbourCellIndex_r14_constraint_1 },
		0, 0, /* No default value */
